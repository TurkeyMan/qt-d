...
public import qt.QtDeclarative.qdeclarativecomponent;

public import qt.QtCore.QObject;
public import qt.QtCore.QList;
public import qt.QtWidgets.qgraphicstransform;
...
class Q_DECLARATIVE_EXPORT QDeclarativeItem : public QGraphicsObject, public QDeclarativeParserStatus
{
    ...
    mixin Q_PROPERTY!(QDeclarativeItem, "*", "parent", "READ", "parentItem", "WRITE", "setParentItem", "NOTIFY", "parentChanged", "DESIGNABLE", "false", "FINAL");
    ...
    mixin Q_PROPERTY!(bool, "activeFocus", "READ", "hasActiveFocus", "NOTIFY", "activeFocusChanged");
    ...
    mixin Q_PROPERTY!(qreal, "implicitWidth", "READ", "implicitWidth", "WRITE", "setImplicitWidth", "NOTIFY", "implicitWidthChanged", "REVISION", "1");
    mixin Q_PROPERTY!(qreal, "implicitHeight", "READ", "implicitHeight", "WRITE", "setImplicitHeight", "NOTIFY", "implicitHeightChanged", "REVISION", "1");
...
public:
    ...
    Q_INVOKABLE QScriptValue mapFromItem(ref const(QScriptValue) item, qreal x, qreal y) const;
    Q_INVOKABLE QScriptValue mapToItem(ref const(QScriptValue) item, qreal x, qreal y) const;
...
protected:
    ...
    /+virtual+/ QVariant itemChange(GraphicsItemChange, ref const(QVariant) );
...
T qobject_cast(T)(QGraphicsObject *o)
{
    QObject *obj = o;
...
// ### move to QGO
T qobject_cast(T)(QGraphicsItem *item)
{
    if (!item) return 0;
