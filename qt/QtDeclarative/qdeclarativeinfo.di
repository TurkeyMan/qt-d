...
namespace QtDeclarative {
    ...
    Q_DECLARATIVE_EXPORT QDeclarativeInfo qmlInfo(const(QObject)* me,
                                                  ref const(QDeclarativeError) error);
    Q_DECLARATIVE_EXPORT QDeclarativeInfo qmlInfo(const(QObject)* me,
                                                  ref const(QList<QDeclarativeError>) errors);
}
...
{
public:
    QDeclarativeInfo(ref const(QDeclarativeInfo) );
    ~QDeclarativeInfo();
    ...
    /+inline+/ QDeclarativeInfo &operator<<(ref const(QString)  t) { QDebug::operator<<(t.toLocal8Bit().constData()); return *this; }
    /+inline+/ QDeclarativeInfo &operator<<(ref const(QStringRef)  t) { return operator<<(t.toString()); }
    /+inline+/ QDeclarativeInfo &operator<<(ref const(QLatin1String) t) { QDebug::operator<<(t.latin1()); return *this; }
    /+inline+/ QDeclarativeInfo &operator<<(ref const(QByteArray)  t) { QDebug::operator<<(t); return *this; }
    ...
    /+inline+/ QDeclarativeInfo &operator<<(ref const(QUrl) t) { static_cast<QDebug &>(*this) << t; return *this; }
#endif
