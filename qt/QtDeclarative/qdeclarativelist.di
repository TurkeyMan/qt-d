...
public:
    ...
    bool operator==(ref const(QDeclarativeListProperty) o) const {
...
public:
    ...
    QDeclarativeListReference(ref const(QDeclarativeListReference) );
    QDeclarativeListReference &operator=(ref const(QDeclarativeListReference) );
    ~QDeclarativeListReference();
