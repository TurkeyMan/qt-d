...
public:
    ...
    QDeclarativeScriptString(ref const(QDeclarativeScriptString) );
    ~QDeclarativeScriptString();

    QDeclarativeScriptString &operator=(ref const(QDeclarativeScriptString) );
    ...
    void setScript(ref const(QString) );
