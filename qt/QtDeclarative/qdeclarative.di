...
public import qt.QtDeclarative.qdeclarativeprivate;
public import qt.QtDeclarative.qdeclarativeparserstatus;
public import qt.QtDeclarative.qdeclarativepropertyvaluesource;
public import qt.QtDeclarative.qdeclarativepropertyvalueinterceptor;
public import qt.QtDeclarative.qdeclarativelist;
...
int Q_AUTOTEST_EXPORT qmlRegisterTypeNotAvailable(const(char)* uri, int versionMajor, int versionMinor, const(char)* qmlName, ref const(QString) message);
