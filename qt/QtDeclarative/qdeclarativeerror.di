...
public:
    QDeclarativeError();
    QDeclarativeError(ref const(QDeclarativeError) );
    QDeclarativeError &operator=(ref const(QDeclarativeError) );
    ~QDeclarativeError();
...
QDebug Q_DECLARATIVE_EXPORT operator<<(QDebug debug, ref const(QDeclarativeError) error);
