...
public import qt.QtXmlPatterns.QSourceLocation;
...
public:
    ...
    void message(QtMsgType type,
                 ref const(QString) description,
                 ref const(QUrl) identifier = QUrl(),
                 ref const(QSourceLocation) sourceLocation = QSourceLocation());

protected:
    /+virtual+/ void handleMessage(QtMsgType type,
                               ref const(QString) description,
                               ref const(QUrl) identifier,
                               ref const(QSourceLocation) sourceLocation) = 0;
private:
