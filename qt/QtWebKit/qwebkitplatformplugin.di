...
public:
    ...
    /+virtual+/ void show(ref const(QWebSelectData)) = 0;
    /+virtual+/ void hide() = 0;
    /+virtual+/ void setGeometry(ref const(QRect)) = 0;
    /+virtual+/ void setFont(ref const(QFont)) = 0;
...
public:
    ...
    /+virtual+/ void playHapticFeedback(const HapticEvent, ref const(QString) hapticType, const HapticStrength) = 0;
};
...
public:
    ...
    /+virtual+/ void learnWord(ref const(QString) word) = 0;
    /+virtual+/ void ignoreWordInSpellDocument(ref const(QString) word) = 0;
    /+virtual+/ void checkSpellingOfString(ref const(QString) word, int* misspellingLocation, int* misspellingLength) = 0;
    /+virtual+/ QString autoCorrectSuggestionForMisspelledWord(ref const(QString) word) = 0;
    /+virtual+/ void guessesForWord(ref const(QString) word, ref const(QString) context, QStringList& guesses) = 0;

    /+virtual+/ bool isGrammarCheckingEnabled() = 0;
    /+virtual+/ void toggleGrammarChecking() = 0;
    /+virtual+/ void checkGrammarOfString(ref const(QString), QList<GrammarDetail>&, int* badGrammarLocation, int* badGrammarLength) = 0;
};
