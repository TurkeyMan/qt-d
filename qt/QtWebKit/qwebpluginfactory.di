...
public:
    struct QWEBKIT_EXPORT MimeType {
        ...
        bool operator==(ref const(MimeType) other) const;
        /+inline+/ bool operator!=(ref const(MimeType) other) const { return !operator==(other); }
    };
    ...
    /+virtual+/ QObject *create(ref const(QString) mimeType, ref const(QUrl), ref const(QStringList) argumentNames, ref const(QStringList) argumentValues) const = 0;
