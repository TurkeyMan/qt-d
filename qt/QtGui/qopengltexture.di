...
public:
    ...
    explicit QOpenGLTexture(ref const(QImage) image, MipMapGeneration genMipMaps = GenerateMipMaps);
    ~QOpenGLTexture();
    ...
    void setData(ref const(QImage) image, MipMapGeneration genMipMaps = GenerateMipMaps);
