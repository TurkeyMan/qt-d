...
public import qt.QtGui.qinputmethod;
...
class Q_GUI_EXPORT QGuiApplication : public QCoreApplication
{
    ...
    mixin Q_PROPERTY!(QString, "applicationDisplayName", "READ", "applicationDisplayName", "WRITE", "setApplicationDisplayName");
    mixin Q_PROPERTY!(Qt.LayoutDirection, "layoutDirection", "READ", "layoutDirection", "WRITE", "setLayoutDirection", "NOTIFY", "layoutDirectionChanged");
    mixin Q_PROPERTY!(QString, "platformName", "READ", "platformName", "STORED", "false");
...
public:
    ...
    static QFunctionPointer platformFunction(ref const(QByteArray) function);
...
#endif
    void paletteChanged(ref const(QPalette) pal);
