...
public:
    QStandardItem();
    explicit QStandardItem(ref const(QString) text);
    QStandardItem(ref const(QIcon) icon, ref const(QString) text);
    explicit QStandardItem(int rows, int columns = 1);
    /+virtual+/ ~QStandardItem();

    /+virtual+/ QVariant data(int role = Qt.UserRole + 1) const;
    /+virtual+/ void setData(ref const(QVariant) value, int role = Qt.UserRole + 1);
    ...
    /+inline+/ void setSizeHint(ref const(QSize) sizeHint);
    ...
    /+inline+/ void setAccessibleText(ref const(QString) accessibleText);

    /+inline+/ QString accessibleDescription() const {
        return qvariant_cast<QString>(data(Qt.AccessibleDescriptionRole));
    }
    /+inline+/ void setAccessibleDescription(ref const(QString) accessibleDescription);
    ...
    void insertRow(int row, ref const(QList<QStandardItem*>) items);
    void insertColumn(int column, ref const(QList<QStandardItem*>) items);
    void insertRows(int row, ref const(QList<QStandardItem*>) items);
    ...
    /+inline+/ void appendRow(ref const(QList<QStandardItem*>) items);
    /+inline+/ void appendRows(ref const(QList<QStandardItem*>) items);
    /+inline+/ void appendColumn(ref const(QList<QStandardItem*>) items);
...
#endif
    /+virtual+/ bool operator<(ref const(QStandardItem) other) const;

protected:
    QStandardItem(ref const(QStandardItem) other);
    QStandardItem(QStandardItemPrivate &dd);
    QStandardItem &operator=(ref const(QStandardItem) other);
...
/+inline+/ void QStandardItem::setText(ref const(QString) atext)
{ setData(atext, Qt.DisplayRole); }

/+inline+/ void QStandardItem::setIcon(ref const(QIcon) aicon)
{ setData(aicon, Qt.DecorationRole); }

#ifndef QT_NO_TOOLTIP
/+inline+/ void QStandardItem::setToolTip(ref const(QString) atoolTip)
{ setData(atoolTip, Qt.ToolTipRole); }
#endif

#ifndef QT_NO_STATUSTIP
/+inline+/ void QStandardItem::setStatusTip(ref const(QString) astatusTip)
{ setData(astatusTip, Qt.StatusTipRole); }
#endif

#ifndef QT_NO_WHATSTHIS
/+inline+/ void QStandardItem::setWhatsThis(ref const(QString) awhatsThis)
{ setData(awhatsThis, Qt.WhatsThisRole); }
#endif

/+inline+/ void QStandardItem::setSizeHint(ref const(QSize) asizeHint)
{ setData(asizeHint, Qt.SizeHintRole); }

/+inline+/ void QStandardItem::setFont(ref const(QFont) afont)
...
/+inline+/ void QStandardItem::setBackground(ref const(QBrush) abrush)
{ setData(abrush, Qt.BackgroundRole); }

/+inline+/ void QStandardItem::setForeground(ref const(QBrush) abrush)
...
/+inline+/ void QStandardItem::setAccessibleText(ref const(QString) aaccessibleText)
{ setData(aaccessibleText, Qt.AccessibleTextRole); }

/+inline+/ void QStandardItem::setAccessibleDescription(ref const(QString) aaccessibleDescription)
...
/+inline+/ void QStandardItem::appendRow(ref const(QList<QStandardItem*>) aitems)
{ insertRow(rowCount(), aitems); }

/+inline+/ void QStandardItem::appendRows(ref const(QList<QStandardItem*>) aitems)
{ insertRows(rowCount(), aitems); }

/+inline+/ void QStandardItem::appendColumn(ref const(QList<QStandardItem*>) aitems)
...
public:
    ...
    void setItemRoleNames(ref const(QHash<int,QByteArray>) roleNames);
    ...
    QStandardItem *itemFromIndex(ref const(QModelIndex) index) const;
    ...
    void appendRow(ref const(QList<QStandardItem*>) items);
    void appendColumn(ref const(QList<QStandardItem*>) items);
    /+inline+/ void appendRow(QStandardItem *item);
    ...
    QList<QStandardItem*> findItems(ref const(QString) text,
...
private:
    ...
    Q_PRIVATE_SLOT(d_func(), void _q_emitItemChanged(ref const(QModelIndex) topLeft,
                                                     ref const(QModelIndex) bottomRight))
};
...
/+inline+/ bool QStandardItemModel::insertRow(int arow, ref const(QModelIndex) aparent)
{ return QAbstractItemModel::insertRow(arow, aparent); }
/+inline+/ bool QStandardItemModel::insertColumn(int acolumn, ref const(QModelIndex) aparent)
...
Q_GUI_EXPORT QDataStream &operator<<(QDataStream &out, ref const(QStandardItem) item);
#endif
