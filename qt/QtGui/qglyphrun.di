...
public import qt.QtGui.qrawfont;
...
public:
    ...
    QGlyphRun();
    QGlyphRun(ref const(QGlyphRun) other);
    ~QGlyphRun();
    ...
    QGlyphRun &operator=(ref const(QGlyphRun) other);

    bool operator==(ref const(QGlyphRun) other) const;
    /+inline+/ bool operator!=(ref const(QGlyphRun) other) const
