...
public:
    ...
    explicit QTextCursor(ref const(QTextBlock) block);
    explicit QTextCursor(QTextCursorPrivate *d);
    QTextCursor(ref const(QTextCursor) cursor);
    QTextCursor &operator=(ref const(QTextCursor) other);
    ~QTextCursor();
    ...
    void insertImage(ref const(QImage) image, ref const(QString) name = QString());
