...
public import qt.QtGui.qtextlayout;
...
protected:
    ...
    void setFormat(ref const(QTextFormat) format);
...
public:
    ...
    /+inline+/ void setFrameFormat(ref const(QTextFrameFormat) format);
    ...
    public:
        iterator();
        iterator(ref const(iterator) o);
        iterator &operator=(ref const(iterator) o);
        ...
        /+inline+/ bool operator==(ref const(iterator) o) const { return f == o.f && cf == o.cf && cb == o.cb; }
        /+inline+/ bool operator!=(ref const(iterator) o) const { return f != o.f || cf != o.cf || cb != o.cb; }
        iterator &operator++();
...
/+inline+/ void QTextFrame::setFrameFormat(ref const(QTextFrameFormat) aformat)
...
public:
    ...
    /+inline+/ QTextBlock(ref const(QTextBlock) o) : p(o.p), n(o.n) {}
    /+inline+/ QTextBlock &operator=(ref const(QTextBlock) o) { p = o.p; n = o.n; return *this; }

    bool isValid() const;

    /+inline+/ bool operator==(ref const(QTextBlock) o) const { return p == o.p && n == o.n; }
    /+inline+/ bool operator!=(ref const(QTextBlock) o) const { return p != o.p || n != o.n; }
    /+inline+/ bool operator<(ref const(QTextBlock) o) const { return position() < o.position(); }
    ...
    public:
        ...
        iterator(ref const(iterator) o) : p(o.p), b(o.b), e(o.e), n(o.n) {}

        QTextFragment fragment() const;

        bool atEnd() const { return n == e; }

        /+inline+/ bool operator==(ref const(iterator) o) const { return p == o.p && n == o.n; }
        /+inline+/ bool operator!=(ref const(iterator) o) const { return p != o.p || n != o.n; }
        iterator &operator++();
        /+inline+/ iterator operator++(int) { iterator tmp = *this; operator++(); return tmp; }
        iterator &operator--();
...
public:
    ...
    /+inline+/ QTextFragment(ref const(QTextFragment) o) : p(o.p), n(o.n), ne(o.ne) {}
    /+inline+/ QTextFragment &operator=(ref const(QTextFragment) o) { p = o.p; n = o.n; ne = o.ne; return *this; }

    /+inline+/ bool isValid() const { return p && n; }

    /+inline+/ bool operator==(ref const(QTextFragment) o) const { return p == o.p && n == o.n; }
    /+inline+/ bool operator!=(ref const(QTextFragment) o) const { return p != o.p || n != o.n; }
    /+inline+/ bool operator<(ref const(QTextFragment) o) const { return position() < o.position(); }
