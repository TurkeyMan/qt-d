...
public:
    ...
    /+virtual+/ bool loadPicture(ref const(QString) format, ref const(QString) filename, QPicture *pic);
    /+virtual+/ bool savePicture(ref const(QString) format, ref const(QString) filename, ref const(QPicture) pic);
    /+virtual+/ bool installIOHandler(ref const(QString) format) = 0;
