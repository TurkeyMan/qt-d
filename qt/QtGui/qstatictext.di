...
public:
    ...
    QStaticText();
    QStaticText(ref const(QString) text);
    QStaticText(ref const(QStaticText) other);
    ~QStaticText();
    ...
    void prepare(ref const(QTransform) matrix = QTransform(), ref const(QFont) font = QFont());

    void setPerformanceHint(PerformanceHint performanceHint);
    PerformanceHint performanceHint() const;

    QStaticText &operator=(ref const(QStaticText) );
