...
public import qt.QtGui.qfontdatabase;
...
public:
    ...
    QRawFont();
    QRawFont(ref const(QString) fileName,
             qreal pixelSize,
             QFont::HintingPreference hintingPreference = QFont::PreferDefaultHinting);
    QRawFont(ref const(QByteArray) fontData,
             qreal pixelSize,
             QFont::HintingPreference hintingPreference = QFont::PreferDefaultHinting);
    QRawFont(ref const(QRawFont) other);
    ~QRawFont();

    bool isValid() const;

    QRawFont &operator=(ref const(QRawFont) other);

    void swap(QRawFont &other) { qSwap(d, other.d); }

    bool operator==(ref const(QRawFont) other) const;
    /+inline+/ bool operator!=(ref const(QRawFont) other) const
    ...
    /+inline+/ QVector<QPointF> advancesForGlyphIndexes(ref const(QVector<quint32>) glyphIndexes) const;
    /+inline+/ QVector<QPointF> advancesForGlyphIndexes(ref const(QVector<quint32>) glyphIndexes, LayoutFlags layoutFlags) const;
    ...
    QImage alphaMapForGlyph(quint32 glyphIndex,
                            ...
                            ref const(QTransform) transform = QTransform()) const;
...
/+inline+/ QVector<QPointF> QRawFont::advancesForGlyphIndexes(ref const(QVector<quint32>) glyphIndexes, QRawFont::LayoutFlags layoutFlags) const
{
...
/+inline+/ QVector<QPointF> QRawFont::advancesForGlyphIndexes(ref const(QVector<quint32>) glyphIndexes) const
{
