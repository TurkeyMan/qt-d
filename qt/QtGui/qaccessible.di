...
public:
    ...
    typedef QAccessibleInterface*(*InterfaceFactory)(ref const(QString) key, QObject*);
    ...
    static QPair< int, int > qAccessibleTextBoundaryHelper(ref const(QTextCursor) cursor, TextBoundaryType boundaryType);
...
Q_GUI_EXPORT bool operator==(ref const(QAccessible::State) first, ref const(QAccessible::State) second);
...
public:
    ...
    /+virtual+/ void setText(QAccessible::Text t, ref const(QString) text) = 0;
...
public:
    ...
    /+virtual+/ int offsetAtPoint(ref const(QPoint) point) const = 0;
...
public:
    ...
    /+virtual+/ void insertText(int offset, ref const(QString) text) = 0;
    /+virtual+/ void replaceText(int startOffset, int endOffset, ref const(QString) text) = 0;
};
...
public:
    ...
    /+virtual+/ void setCurrentValue(ref const(QVariant) value) = 0;
...
public:
    ...
    /+virtual+/ QString localizedActionName(ref const(QString) name) const;
    /+virtual+/ QString localizedActionDescription(ref const(QString) name) const;
    /+virtual+/ void doAction(ref const(QString) actionName) = 0;
    /+virtual+/ QStringList keyBindingsForAction(ref const(QString) actionName) const = 0;

    static ref const(QString) pressAction();
    static ref const(QString) increaseAction();
    static ref const(QString) decreaseAction();
    static ref const(QString) showMenuAction();
    static ref const(QString) setFocusAction();
    static ref const(QString) toggleAction();
};
...
{
public:
    /+inline+/ QAccessibleTextInsertEvent(QObject *obj, int position, ref const(QString) text)
        : QAccessibleTextCursorEvent(obj, position + text.length())
        , m_position(position), m_text(text)
    {
        m_type = QAccessible::TextInserted;
    }
    /+inline+/ QAccessibleTextInsertEvent(QAccessibleInterface *iface, int position, ref const(QString) text)
...
{
public:
    /+inline+/ QAccessibleTextRemoveEvent(QObject *obj, int position, ref const(QString) text)
        : QAccessibleTextCursorEvent(obj, position)
        , m_position(position), m_text(text)
    {
        m_type = QAccessible::TextRemoved;
    }
    /+inline+/ QAccessibleTextRemoveEvent(QAccessibleInterface *iface, int position, ref const(QString) text)
...
{
public:
    /+inline+/ QAccessibleTextUpdateEvent(QObject *obj, int position, ref const(QString) oldText, ref const(QString) text)
        : QAccessibleTextCursorEvent(obj, position + text.length())
        , m_position(position), m_oldText(oldText), m_text(text)
    {
        m_type = QAccessible::TextUpdated;
    }
    /+inline+/ QAccessibleTextUpdateEvent(QAccessibleInterface *iface, int position, ref const(QString) oldText, ref const(QString) text)
        : QAccessibleTextCursorEvent(iface, position + text.length())
        , m_position(position), m_oldText(oldText), m_text(text)
    {
        m_type = QAccessible::TextUpdated;
...
{
public:
    /+inline+/ QAccessibleValueChangeEvent(QObject *obj, ref const(QVariant) val)
        : QAccessibleEvent(obj, QAccessible::InvalidEvent)
      , m_value(val)
    {
        m_type = QAccessible::ValueChanged;
    }
    /+inline+/ QAccessibleValueChangeEvent(QAccessibleInterface *iface, ref const(QVariant) val)
        : QAccessibleEvent(iface, QAccessible::InvalidEvent)
      , m_value(val)
    {
        m_type = QAccessible::ValueChanged;
    ...
    void setValue(ref const(QVariant)  val) { m_value= val; }
...
Q_GUI_EXPORT QString qAccessibleLocalizedActionDescription(ref const(QString) actionName);

#ifndef QT_NO_DEBUG_STREAM
Q_GUI_EXPORT QDebug operator<<(QDebug d, const(QAccessibleInterface)* iface);
Q_GUI_EXPORT QDebug operator<<(QDebug d, ref const(QAccessibleEvent) ev);
#endif
