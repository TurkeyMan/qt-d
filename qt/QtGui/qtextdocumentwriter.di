...
public:
    QTextDocumentWriter();
    QTextDocumentWriter(QIODevice *device, ref const(QByteArray) format);
    explicit QTextDocumentWriter(ref const(QString) fileName, ref const(QByteArray) format = QByteArray());
    ~QTextDocumentWriter();
