...
public:
    ...
    void setRestartCommand(ref const(QStringList));
    QStringList restartCommand() const;
    void setDiscardCommand(ref const(QStringList));
    QStringList discardCommand() const;

    void setManagerProperty(ref const(QString) name, ref const(QString) value);
    void setManagerProperty(ref const(QString) name, ref const(QStringList) value);
