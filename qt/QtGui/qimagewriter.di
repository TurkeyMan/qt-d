...
public:
    ...
    QImageWriter();
    explicit QImageWriter(QIODevice *device, ref const(QByteArray) format);
    explicit QImageWriter(ref const(QString) fileName, ref const(QByteArray) format = QByteArray());
    ~QImageWriter();
