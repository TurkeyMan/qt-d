...
public import qt.QtGui.qquaternion;
public import qt.QtGui.qgenericmatrix;
...
public:
    ...
    QMatrix4x4(ref const(QTransform) transform);
    QMatrix4x4(ref const(QMatrix) matrix);

    /+inline+/ ref const(float) operator()(int row, int column) const;
    /+inline+/ float& operator()(int row, int column);

#ifndef QT_NO_VECTOR4D
    /+inline+/ QVector4D column(int index) const;
    /+inline+/ void setColumn(int index, ref const(QVector4D) value);

    /+inline+/ QVector4D row(int index) const;
    /+inline+/ void setRow(int index, ref const(QVector4D) value);
#endif
    ...
    /+inline+/ QMatrix4x4& operator+=(ref const(QMatrix4x4) other);
    /+inline+/ QMatrix4x4& operator-=(ref const(QMatrix4x4) other);
    /+inline+/ QMatrix4x4& operator*=(ref const(QMatrix4x4) other);
    /+inline+/ QMatrix4x4& operator*=(float factor);
    QMatrix4x4& operator/=(float divisor);
    /+inline+/ bool operator==(ref const(QMatrix4x4) other) const;
    /+inline+/ bool operator!=(ref const(QMatrix4x4) other) const;

    friend QMatrix4x4 operator+(ref const(QMatrix4x4) m1, ref const(QMatrix4x4) m2);
    friend QMatrix4x4 operator-(ref const(QMatrix4x4) m1, ref const(QMatrix4x4) m2);
    friend QMatrix4x4 operator*(ref const(QMatrix4x4) m1, ref const(QMatrix4x4) m2);
#ifndef QT_NO_VECTOR3D
    friend QVector3D operator*(ref const(QMatrix4x4) matrix, ref const(QVector3D) vector);
    friend QVector3D operator*(ref const(QVector3D) vector, ref const(QMatrix4x4) matrix);
#endif
#ifndef QT_NO_VECTOR4D
    friend QVector4D operator*(ref const(QVector4D) vector, ref const(QMatrix4x4) matrix);
    friend QVector4D operator*(ref const(QMatrix4x4) matrix, ref const(QVector4D) vector);
#endif
    friend QPoint operator*(ref const(QPoint) point, ref const(QMatrix4x4) matrix);
    friend QPointF operator*(ref const(QPointF) point, ref const(QMatrix4x4) matrix);
    friend QMatrix4x4 operator-(ref const(QMatrix4x4) matrix);
    friend QPoint operator*(ref const(QMatrix4x4) matrix, ref const(QPoint) point);
    friend QPointF operator*(ref const(QMatrix4x4) matrix, ref const(QPointF) point);
    friend QMatrix4x4 operator*(float factor, ref const(QMatrix4x4) matrix);
    friend QMatrix4x4 operator*(ref const(QMatrix4x4) matrix, float factor);
    friend Q_GUI_EXPORT QMatrix4x4 operator/(ref const(QMatrix4x4) matrix, float divisor);

    friend /+inline+/ bool qFuzzyCompare(ref const(QMatrix4x4) m1, ref const(QMatrix4x4) m2);
...
#endif
    void viewport(ref const(QRectF) rect);
    ...
    QPoint map(ref const(QPoint) point) const;
    QPointF map(ref const(QPointF) point) const;
#ifndef QT_NO_VECTOR3D
    QVector3D map(ref const(QVector3D) point) const;
    QVector3D mapVector(ref const(QVector3D) vector) const;
#endif
#ifndef QT_NO_VECTOR4D
    QVector4D map(ref const(QVector4D) point) const;
#endif
    ...
    friend Q_GUI_EXPORT QDebug operator<<(QDebug dbg, ref const(QMatrix4x4) m);
#endif
...
/+inline+/ ref const(float) QMatrix4x4::operator()(int aRow, int aColumn) const
{
...
/+inline+/ void QMatrix4x4::setColumn(int index, ref const(QVector4D) value)
{
    Q_ASSERT(index >= 0 && index < 4);
    m[index][0] = value.x();
    m[index][1] = value.y();
...
/+inline+/ void QMatrix4x4::setRow(int index, ref const(QVector4D) value)
{
    Q_ASSERT(index >= 0 && index < 4);
    m[0][index] = value.x();
    m[1][index] = value.y();
...
/+inline+/ QMatrix4x4& QMatrix4x4::operator+=(ref const(QMatrix4x4) other)
{
    m[0][0] += other.m[0][0];
    m[0][1] += other.m[0][1];
    m[0][2] += other.m[0][2];
...
/+inline+/ bool QMatrix4x4::operator==(ref const(QMatrix4x4) other) const
{
...
/+inline+/ QMatrix4x4 operator+(ref const(QMatrix4x4) m1, ref const(QMatrix4x4) m2)
{
    QMatrix4x4 m(1);
...
/+inline+/ QVector3D operator*(ref const(QVector3D) vector, ref const(QMatrix4x4) matrix)
{
    float x, y, z, w;
...
/+inline+/ QVector3D operator*(ref const(QMatrix4x4) matrix, ref const(QVector3D) vector)
{
    float x, y, z, w;
...
/+inline+/ QVector4D operator*(ref const(QVector4D) vector, ref const(QMatrix4x4) matrix)
{
    float x, y, z, w;
    x = vector.x() * matrix.m[0][0] +
        vector.y() * matrix.m[0][1] +
...
/+inline+/ QVector4D operator*(ref const(QMatrix4x4) matrix, ref const(QVector4D) vector)
{
    float x, y, z, w;
    x = vector.x() * matrix.m[0][0] +
        vector.y() * matrix.m[1][0] +
...
/+inline+/ QPoint operator*(ref const(QPoint) point, ref const(QMatrix4x4) matrix)
{
    float xin, yin;
    float x, y, w;
    xin = point.x();
...
/+inline+/ QPointF operator*(ref const(QPointF) point, ref const(QMatrix4x4) matrix)
{
    float xin, yin;
    float x, y, w;
    xin = point.x();
...
/+inline+/ QPoint operator*(ref const(QMatrix4x4) matrix, ref const(QPoint) point)
{
    float xin, yin;
    float x, y, w;
    xin = point.x();
...
/+inline+/ QPointF operator*(ref const(QMatrix4x4) matrix, ref const(QPointF) point)
{
    float xin, yin;
    float x, y, w;
    xin = point.x();
...
/+inline+/ QMatrix4x4 operator-(ref const(QMatrix4x4) matrix)
{
    QMatrix4x4 m(1);
...
/+inline+/ QMatrix4x4 operator*(float factor, ref const(QMatrix4x4) matrix)
{
    QMatrix4x4 m(1);
...
/+inline+/ QMatrix4x4 operator*(ref const(QMatrix4x4) matrix, float factor)
{
    QMatrix4x4 m(1);
    m.m[0][0] = matrix.m[0][0] * factor;
    m.m[0][1] = matrix.m[0][1] * factor;
...
/+inline+/ bool qFuzzyCompare(ref const(QMatrix4x4) m1, ref const(QMatrix4x4) m2)
{
...
/+inline+/ QPoint QMatrix4x4::map(ref const(QPoint) point) const
{
    return *this * point;
}

/+inline+/ QPointF QMatrix4x4::map(ref const(QPointF) point) const
{
    return *this * point;
}
...
/+inline+/ QVector3D QMatrix4x4::map(ref const(QVector3D) point) const
{
    return *this * point;
}

/+inline+/ QVector3D QMatrix4x4::mapVector(ref const(QVector3D) vector) const
{
    if (flagBits < Scale) {
        // Translation
        return vector;
...
/+inline+/ QVector4D QMatrix4x4::map(ref const(QVector4D) point) const
{
    return *this * point;
}
...
/+inline+/ void QMatrix4x4::viewport(ref const(QRectF) rect)
{
    viewport(rect.x(), rect.y(), rect.width(), rect.height());
}

#ifndef QT_NO_DEBUG_STREAM
Q_GUI_EXPORT QDebug operator<<(QDebug dbg, ref const(QMatrix4x4) m);
#endif

#ifndef QT_NO_DATASTREAM
Q_GUI_EXPORT QDataStream &operator<<(QDataStream &, ref const(QMatrix4x4) );
...
template <int N, int M>
QT_DEPRECATED QGenericMatrix<N, M, float> qGenericMatrixFromMatrix4x4(ref const(QMatrix4x4) matrix)
{
    QGenericMatrix<N, M, float> result;
