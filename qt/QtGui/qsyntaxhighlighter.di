...
public Q_SLOTS:
    void rehighlight();
    void rehighlightBlock(ref const(QTextBlock) block);

protected:
    /+virtual+/ void highlightBlock(ref const(QString) text) = 0;

    void setFormat(int start, int count, ref const(QTextCharFormat) format);
    void setFormat(int start, int count, ref const(QColor) color);
    void setFormat(int start, int count, ref const(QFont) font);
