...
public:
    ...
    /+virtual+/ void updateState(ref const(QPaintEngineState) state) = 0;
    ...
    /+virtual+/ void drawPixmap(ref const(QRectF) r, ref const(QPixmap) pm, ref const(QRectF) sr) = 0;
    ...
    void setSystemClip(ref const(QRegion) baseClip);
    QRegion systemClip() const;

    void setSystemRect(ref const(QRect) rect);
