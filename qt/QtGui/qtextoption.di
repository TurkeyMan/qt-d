...
public:
    ...
    struct Q_GUI_EXPORT Tab {
        ...
        /+inline+/ bool operator==(ref const(Tab) other) const {
    ...
    QTextOption(ref const(QTextOption) o);
    QTextOption &operator=(ref const(QTextOption) o);
