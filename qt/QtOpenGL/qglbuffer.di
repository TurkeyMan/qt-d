...
extern(C++) class QGLBufferPrivate;

extern(C++) class Q_OPENGL_EXPORT QGLBuffer
{
public:
    enum Type
    {
    ...
    QGLBuffer(ref const(QGLBuffer) other);
    ~QGLBuffer();

    QGLBuffer &operator=(ref const(QGLBuffer) other);
