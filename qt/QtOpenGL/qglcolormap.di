...
public import QtOpenGL.qtopenglglobal;


extern(C++) class Q_OPENGL_EXPORT QGLColormap
{
public:
    QGLColormap();
    QGLColormap(ref const(QGLColormap) );
    ~QGLColormap();

    QGLColormap &operator=(ref const(QGLColormap) );
    ...
    void   setEntry(int idx, ref const(QColor)  color);
