...
template <int size> struct QBasicAtomicOps: QGenericAtomicOps<QBasicAtomicOps<size> >
{
    ...
    template <typename T> static bool testAndSetRelaxed(T &_q_value, T expectedValue, T newValue) nothrow;
    template <typename T> static bool testAndSetRelaxed(T &_q_value, T expectedValue,
                                                        T newValue, T *currentValue) nothrow;
...
template<> template <typename T> inline
bool QBasicAtomicOps<4>::testAndSetRelaxed(T &_q_value, T expectedValue, T newValue) nothrow
{
    int result;
    asm volatile("0:\n"
...
template<> template <typename T> inline
bool QBasicAtomicOps<4>::testAndSetRelaxed(T &_q_value, T expectedValue, T newValue, T *currentValue) nothrow
{
    T tempValue;
    int result;
    asm volatile("0:\n"
...
template<> template <typename T> inline
T QBasicAtomicOps<4>::fetchAndStoreRelaxed(T &_q_value, T newValue) nothrow
{
    T originalValue;
    int result;
    asm volatile("0:\n"
...
template<> template<typename T> inline
bool QBasicAtomicOps<1>::ref(T &_q_value) nothrow
{
    T newValue;
    int result;
    asm volatile("0:\n"
...
template<> template <typename T> inline
bool QBasicAtomicOps<1>::deref(T &_q_value) nothrow
{
    T newValue;
    int result;
    asm volatile("0:\n"
...
template<> template <typename T> inline
bool QBasicAtomicOps<1>::testAndSetRelaxed(T &_q_value, T expectedValue, T newValue) nothrow
{
    T result;
    asm volatile("0:\n"
...
template<> template <typename T> inline
bool QBasicAtomicOps<1>::testAndSetRelaxed(T &_q_value, T expectedValue, T newValue, T *currentValue) nothrow
{
    T tempValue;
    T result;
    asm volatile("0:\n"
...
template<> template <typename T> inline
T QBasicAtomicOps<1>::fetchAndStoreRelaxed(T &_q_value, T newValue) nothrow
{
    T originalValue;
    int result;
    asm volatile("0:\n"
...
template<> template<typename T> inline
bool QBasicAtomicOps<2>::ref(T &_q_value) nothrow
{
    T newValue;
    int result;
    asm volatile("0:\n"
...
template<> template <typename T> inline
bool QBasicAtomicOps<2>::deref(T &_q_value) nothrow
{
    T newValue;
    int result;
    asm volatile("0:\n"
...
template<> template <typename T> inline
bool QBasicAtomicOps<2>::testAndSetRelaxed(T &_q_value, T expectedValue, T newValue) nothrow
{
    T result;
    asm volatile("0:\n"
...
template<> template <typename T> inline
bool QBasicAtomicOps<2>::testAndSetRelaxed(T &_q_value, T expectedValue, T newValue, T *currentValue) nothrow
{
    T tempValue;
    T result;
    asm volatile("0:\n"
...
template<> template <typename T> inline
T QBasicAtomicOps<2>::fetchAndStoreRelaxed(T &_q_value, T newValue) nothrow
{
    T originalValue;
    int result;
    asm volatile("0:\n"
...
template<> template <typename T> inline
bool QBasicAtomicOps<8>::testAndSetRelaxed(T &_q_value, T expectedValue, T newValue) nothrow
{
    T result;
    asm volatile("0:\n"
...
template<> template <typename T> inline
bool QBasicAtomicOps<8>::testAndSetRelaxed(T &_q_value, T expectedValue, T newValue, T *currentValue) nothrow
{
    T tempValue;
    T result;
    asm volatile("0:\n"
...
template<> template <typename T> inline
T QBasicAtomicOps<8>::fetchAndStoreRelaxed(T &_q_value, T newValue) nothrow
{
    T originalValue;
    int result;
    asm volatile("0:\n"
...
/+inline+/ bool QBasicAtomicInt::ref() nothrow
{
    int newValue;
    int result;
    retry:
...
/+inline+/ bool QBasicAtomicInt::deref() nothrow
{
    int newValue;
    int result;
    retry:
...
/+inline+/ bool QBasicAtomicInt::testAndSetRelaxed(int expectedValue, int newValue) nothrow
{
    int result;
    retry:
    __asm {
...
/+inline+/ int QBasicAtomicInt::fetchAndStoreRelaxed(int newValue) nothrow
{
    int originalValue;
    int result;
    retry:
...
/+inline+/ int QBasicAtomicInt::fetchAndAddRelaxed(int valueToAdd) nothrow
{
    int originalValue;
    int newValue;
    int result;
...
template <typename T>
Q_INLINE_TEMPLATE bool QBasicAtomicPointer<T>::testAndSetRelaxed(T *expectedValue, T *newValue) nothrow
{
    T *result;
    retry:
    __asm {
...
template <typename T>
Q_INLINE_TEMPLATE T *QBasicAtomicPointer<T>::fetchAndStoreRelaxed(T *newValue) nothrow
{
    T *originalValue;
    int result;
    retry:
...
template <typename T>
Q_INLINE_TEMPLATE T *QBasicAtomicPointer<T>::fetchAndAddRelaxed(qptrdiff valueToAdd) nothrow
{
    T *originalValue;
    T *newValue;
    int result;
