...
public:
    ...
    QT_ASCII_CAST_WARN explicit QChar(char c) : ucs(uchar(c)) { }
    QT_ASCII_CAST_WARN explicit QChar(uchar c) : ucs(c) { }
#endif
    // Unicode information
...
export QDataStream &operator<<(QDataStream &, QChar);
export QDataStream &operator>>(QDataStream &, QChar &);
#endif
