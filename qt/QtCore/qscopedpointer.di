...
template <class T, extern(C++) class Cleanup>
...
extern(C++) class QScopedArrayPointer : QScopedPointer<T, Cleanup>
{
public:
    ...
    /+inline+/ ref const(T) operator[](int i) const
    {
        return this->d[i];
    }
