...
extern(C++, Qt) {
    ...
    mixin Q_DECLARE_FLAGS!("KeyboardModifiers", KeyboardModifier);
    ...
    mixin Q_DECLARE_FLAGS!("MouseButtons", MouseButton);
    ...
    mixin Q_DECLARE_FLAGS!("Orientations", Orientation);
    ...
    mixin Q_DECLARE_FLAGS!("Alignment", AlignmentFlag);
    ...
    mixin Q_DECLARE_FLAGS!("WindowFlags", WindowType);
    ...
    mixin Q_DECLARE_FLAGS!("WindowStates", WindowState);
    ...
    mixin Q_DECLARE_FLAGS!("ApplicationStates", ApplicationState);
    ...
    mixin Q_DECLARE_FLAGS!("ScreenOrientations", ScreenOrientation);
    ...
    mixin Q_DECLARE_FLAGS!("ImageConversionFlags", ImageConversionFlag);
    ...
    mixin Q_DECLARE_FLAGS!("DockWidgetAreas", DockWidgetArea);
    ...
    mixin Q_DECLARE_FLAGS!("ToolBarAreas", ToolBarArea);
    ...
    mixin Q_DECLARE_FLAGS!("Edges", Edge);
    ...
    mixin Q_DECLARE_FLAGS!("InputMethodQueries", InputMethodQuery);
    ...
    mixin Q_DECLARE_FLAGS!("InputMethodHints", InputMethodHint);
    ...
    mixin Q_DECLARE_FLAGS!("FindChildOptions", FindChildOption);
    ...
    mixin Q_DECLARE_FLAGS!("DropActions", DropAction);
    ...
    mixin Q_DECLARE_FLAGS!("ItemFlags", ItemFlag);
    ...
    mixin Q_DECLARE_FLAGS!("MatchFlags", MatchFlag);

    alias HANDLE = void*;
    static if(QT_DEPRECATED_SINCE(5, 0))
        alias WFlags = WindowFlags;
    ...
    mixin Q_DECLARE_FLAGS!("TextInteractionFlags", TextInteractionFlag);
    ...
    mixin Q_DECLARE_FLAGS!("TouchPointStates", TouchPointState);
...
version(QT_NO_GESTURES) {} else {
    ...
    mixin Q_DECLARE_FLAGS!("GestureFlags", GestureFlag);
    ...
    mixin Q_DECLARE_FLAGS!("MouseEventFlags", MouseEventFlag);

}

mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.MouseButtons);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.Orientations);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.KeyboardModifiers);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.WindowFlags);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.Alignment);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.Edges);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.ImageConversionFlags);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.DockWidgetAreas);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.ToolBarAreas);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.WindowStates);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.ScreenOrientations);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.DropActions);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.ItemFlags);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.MatchFlags);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.TextInteractionFlags);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.InputMethodQueries);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.InputMethodHints);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.TouchPointStates);
mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.MouseEventFlags);
version(QT_NO_GESTURES) {} else
    mixin Q_DECLARE_OPERATORS_FOR_FLAGS!(Qt.GestureFlags);

typedef bool (*qInternalCallback)(void **);

export extern(C++) class QInternal {
public:
