...
extern(C++) class QEventPrivate;
extern(C++) class export QEvent           // event base class
{
    Q_GADGET
...
public:
    ...
    QEvent(ref const(QEvent) other);
    /+virtual+/ ~QEvent();
    QEvent &operator=(ref const(QEvent) other);
...
private:
    ...
    friend extern(C++) class QShortcutMap;
    friend extern(C++) class QGraphicsView;
    friend extern(C++) class QGraphicsScene;
    friend extern(C++) class QGraphicsScenePrivate;
}

extern(C++) class export QTimerEvent : QEvent
{
public:
...
extern(C++) class export QChildEvent : QEvent
{
public:
...
extern(C++) class export QDynamicPropertyChangeEvent : QEvent
{
public:
    explicit QDynamicPropertyChangeEvent(ref const(QByteArray) name);
...
extern(C++) class export QDeferredDeleteEvent : QEvent
{
public:
