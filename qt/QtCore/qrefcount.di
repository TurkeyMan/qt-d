...
extern(C++) class RefCount
{
public:
    /+inline+/ bool ref() nothrow {
    ...
    void initializeOwned() nothrow { atomic.store(1); }
    void initializeUnsharable() nothrow { atomic.store(0); }
