...
extern(C++) class QStringMatcherPrivate;

extern(C++) class export QStringMatcher
{
public:
    QStringMatcher();
    explicit QStringMatcher(ref const(QString) pattern,
                   Qt.CaseSensitivity cs = Qt.CaseSensitive);
    QStringMatcher(const(QChar)* uc, int len,
                   Qt.CaseSensitivity cs = Qt.CaseSensitive);
    QStringMatcher(ref const(QStringMatcher) other);
    ~QStringMatcher();

    QStringMatcher &operator=(ref const(QStringMatcher) other);
