...
struct QAtomicOps<int> : QGenericAtomicOps<QAtomicOps<int> >
{
    ...
    export static bool testAndSetRelaxed(int &_q_value, int expectedValue, int newValue) nothrow;
}
...
struct QAtomicOps<long long> : QGenericAtomicOps<QAtomicOps<long long> >
{
    ...
    static /+inline+/ bool isTestAndSetNative() nothrow { return false; }
    static /+inline+/ bool isTestAndSetWaitFree() nothrow { return false; }
    export static bool testAndSetRelaxed(Type &_q_value, Type expectedValue, Type newValue) nothrow;
}
...
struct QAtomicOps<void *> : QGenericAtomicOps<QAtomicOps<void *> >
{
    ...
    static /+inline+/ bool isTestAndSetNative() nothrow { return false; }
    static /+inline+/ bool isTestAndSetWaitFree() nothrow { return false; }
    export static bool testAndSetRelaxed(void *&_q_value, void *expectedValue, void *newValue) nothrow;
}
...
struct QAtomicOps<T *> : QGenericAtomicOps<QAtomicOps<T *> >
{
    ...
    static /+inline+/ bool isTestAndSetNative() nothrow { return false; }
    static /+inline+/ bool isTestAndSetWaitFree() nothrow { return false; }
    static /+inline+/ bool testAndSetRelaxed(T *&_q_value, T *expectedValue, T *newValue) nothrow
    {
