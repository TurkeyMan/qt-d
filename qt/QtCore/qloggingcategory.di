...
extern(C++) class export QLoggingCategory
{
...
public:
    ...
    ref const(QLoggingCategory) operator()() const { return *this; }
    ...
    static void setFilterRules(ref const(QString) rules);
...
#define Q_DECLARE_LOGGING_CATEGORY(name) \
    extern ref const(QLoggingCategory) name();

#if defined(Q_COMPILER_VARIADIC_MACROS) || defined(Q_MOC_RUN)

#define Q_LOGGING_CATEGORY(name, ...) \
    ref const(QLoggingCategory) name() \
    { \
