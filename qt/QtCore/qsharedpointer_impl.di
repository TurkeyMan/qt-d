...
QT_BEGIN_NAMESPACE#pragma qt_sync_stop_processing
#endif

public import new;
public import QtCore.qatomic;
public import QtCore.qobject;    // for qobject_cast
public import QtCore.qhash;    // for qHash
...
//
template <class T> extern(C++) class QWeakPointer;
template <class T> extern(C++) class QSharedPointer;
template <class T> extern(C++) class QEnableSharedFromThis;

extern(C++) class QVariant;

template <class X, extern(C++) class T>
QSharedPointer<X> qSharedPointerCast(ref const(QSharedPointer<T>) ptr);
template <class X, extern(C++) class T>
QSharedPointer<X> qSharedPointerDynamicCast(ref const(QSharedPointer<T>) ptr);
template <class X, extern(C++) class T>
QSharedPointer<X> qSharedPointerConstCast(ref const(QSharedPointer<T>) ptr);

#ifndef QT_NO_QOBJECT
template <class X, extern(C++) class T>
QSharedPointer<X> qSharedPointerObjectCast(ref const(QSharedPointer<T>) ptr);
#endif

namespace QtSharedPointer {
    template <class T> extern(C++) class ExternalRefCount;

    template <class X, extern(C++) class Y> QSharedPointer<X> copyAndSetPointer(X * ptr, ref const(QSharedPointer<Y>) src);

    // used in debug mode to verify the reuse of pointers
    export void internalSafetyCheckAdd(const(void)* , const volatile void *);
    export void internalSafetyCheckRemove(const(void)* );
    ...
    // This extern(C++) class is the d-pointer of QSharedPointer and QWeakPointer.
    //
...
#ifndef QT_NO_QOBJECT
        export static ExternalRefCountData *getAndRef(const(QObject)* );
        export void setQObjectShared(const(QObject)* , bool enable);
        export void checkQObjectShared(const(QObject)* );
#endif
    ...
    // This extern(C++) class extends ExternalRefCountData and implements
    ...
    // This extern(C++) class extends ExternalRefCountData and adds a "T"
...
#ifndef QT_NO_QOBJECT
    export QWeakPointer<QObject> weakPointerFromVariant_internal(ref const(QVariant) variant);
    export QSharedPointer<QObject> sharedPointerFromVariant_internal(ref const(QVariant) variant);
#endif
} // namespace QtSharedPointer
...
public:
    ...
    /+inline+/ QSharedPointer(ref const(QSharedPointer) other) : value(other.value), d(other.d)
    { if (d) ref(); }
    /+inline+/ QSharedPointer &operator=(ref const(QSharedPointer) other)
    {
    ...
    template <class X>
    /+inline+/ QSharedPointer(ref const(QSharedPointer<X>) other) : value(other.value), d(other.d)
    { if (d) ref(); }

    template <class X>
    /+inline+/ QSharedPointer &operator=(ref const(QSharedPointer<X>) other)
    {
    ...
    template <class X>
    /+inline+/ QSharedPointer(ref const(QWeakPointer<X>) other) : value(0), d(0)
    { *this = other; }

    template <class X>
    /+inline+/ QSharedPointer<T> &operator=(ref const(QWeakPointer<X>) other)
...
# endif
    ...
    static /+inline+/ QSharedPointer create(ref const(Arg) arg)
    {
        typedef QtSharedPointer::ExternalRefCountWithContiguousData<T> Private;
# ifdef QT_SHAREDPOINTER_TRACK_POINTERS
        typename Private::DestroyerFn destroy = &Private::safetyCheckDeleter;
...
# endif
    ...
    template <class X>
    /+inline+/ void internalCopy(ref const(QSharedPointer<X>) other)
    {
        Data *o = other.d;
...
public:
#else
    template <class X> friend extern(C++) class QSharedPointer;
    template <class X> friend extern(C++) class QWeakPointer;
    template <class X, extern(C++) class Y> friend QSharedPointer<X> QtSharedPointer::copyAndSetPointer(X * ptr, ref const(QSharedPointer<Y>) src);
#endif
...
public:
    ...
    /+inline+/ QWeakPointer(ref const(QWeakPointer) o) : d(o.d), value(o.value)
    { if (d) d->weakref.ref(); }
    /+inline+/ QWeakPointer &operator=(ref const(QWeakPointer) o)
    {
    ...
    /+inline+/ QWeakPointer(ref const(QSharedPointer<T>) o) : d(o.d), value(o.data())
    { if (d) d->weakref.ref();}
    /+inline+/ QWeakPointer &operator=(ref const(QSharedPointer<T>) o)
    {
        internalSet(o.d, o.value);
        return *this;
    }
    ...
    template <class X>
    /+inline+/ QWeakPointer(ref const(QWeakPointer<X>) o) : d(0), value(0)
    { *this = o; }

    template <class X>
    /+inline+/ QWeakPointer &operator=(ref const(QWeakPointer<X>) o)
    {
    ...
    template <class X>
    /+inline+/ bool operator==(ref const(QWeakPointer<X>) o) const
    ...
    template <class X>
    /+inline+/ QWeakPointer(ref const(QSharedPointer<X>) o) : d(0), value(0)
    { *this = o; }

    template <class X>
    /+inline+/ QWeakPointer &operator=(ref const(QSharedPointer<X>) o)
    {
        QSHAREDPOINTER_VERIFY_AUTO_CAST(T, X); // if you get an error in this line, the cast is invalid
    ...
    template <class X>
    /+inline+/ bool operator==(ref const(QSharedPointer<X>) o) const
    { return d == o.d; }
...
#else
    template <class X> friend extern(C++) class QSharedPointer;
    template <class X> friend extern(C++) class QPointer;
#endif
...
#endif
    QEnableSharedFromThis(ref const(QEnableSharedFromThis) ) {}
    QEnableSharedFromThis &operator=(ref const(QEnableSharedFromThis) ) { return *this; }
...
#endif
    template <class X>
    /+inline+/ void initializeFromSharedPointer(ref const(QSharedPointer<X>) ptr) const
    {
        weakPointer = ptr;
    }
...
//
template <class T, extern(C++) class X>
bool operator==(ref const(QSharedPointer<T>) ptr1, ref const(QSharedPointer<X>) ptr2)
{
...
template <class T, extern(C++) class X>
bool operator==(ref const(QSharedPointer<T>) ptr1, const(X)* ptr2)
{
    return ptr1.data() == ptr2;
}
template <class T, extern(C++) class X>
bool operator==(const(T)* ptr1, ref const(QSharedPointer<X>) ptr2)
{
...
template <class T, extern(C++) class X>
bool operator==(ref const(QSharedPointer<T>) ptr1, ref const(QWeakPointer<X>) ptr2)
{
    return ptr2 == ptr1;
}
template <class T, extern(C++) class X>
...
//
template <class T, extern(C++) class X>
Q_INLINE_TEMPLATE typename QSharedPointer<T>::difference_type operator-(ref const(QSharedPointer<T>) ptr1, ref const(QSharedPointer<X>) ptr2)
{
    return ptr1.data() - ptr2.data();
}
template <class T, extern(C++) class X>
Q_INLINE_TEMPLATE typename QSharedPointer<T>::difference_type operator-(ref const(QSharedPointer<T>) ptr1, X *ptr2)
{
    return ptr1.data() - ptr2;
}
template <class T, extern(C++) class X>
Q_INLINE_TEMPLATE typename QSharedPointer<X>::difference_type operator-(T *ptr1, ref const(QSharedPointer<X>) ptr2)
{
    return ptr1 - ptr2.data();
}
...
//
template <class T, extern(C++) class X>
Q_INLINE_TEMPLATE bool operator<(ref const(QSharedPointer<T>) ptr1, ref const(QSharedPointer<X>) ptr2)
{
    return ptr1.data() < ptr2.data();
}
template <class T, extern(C++) class X>
Q_INLINE_TEMPLATE bool operator<(ref const(QSharedPointer<T>) ptr1, X *ptr2)
{
    return ptr1.data() < ptr2;
}
template <class T, extern(C++) class X>
Q_INLINE_TEMPLATE bool operator<(T *ptr1, ref const(QSharedPointer<X>) ptr2)
{
    return ptr1 < ptr2.data();
}
...
//
template <class T>
Q_INLINE_TEMPLATE uint qHash(ref const(QSharedPointer<T>) ptr, uint seed = 0)
{
...
// helper functions:
    template <class X, extern(C++) class T>
    Q_INLINE_TEMPLATE QSharedPointer<X> copyAndSetPointer(X *ptr, ref const(QSharedPointer<T>) src)
    {
...
// cast operators
template <class X, extern(C++) class T>
Q_INLINE_TEMPLATE QSharedPointer<X> qSharedPointerCast(ref const(QSharedPointer<T>) src)
{
    X *ptr = static_cast<X *>(src.data()); // if you get an error in this line, the cast is invalid
    return QtSharedPointer::copyAndSetPointer(ptr, src);
}
template <class X, extern(C++) class T>
Q_INLINE_TEMPLATE QSharedPointer<X> qSharedPointerCast(ref const(QWeakPointer<T>) src)
{
    return qSharedPointerCast<X, T>(src.toStrongRef());
}

template <class X, extern(C++) class T>
Q_INLINE_TEMPLATE QSharedPointer<X> qSharedPointerDynamicCast(ref const(QSharedPointer<T>) src)
{
...
template <class X, extern(C++) class T>
Q_INLINE_TEMPLATE QSharedPointer<X> qSharedPointerDynamicCast(ref const(QWeakPointer<T>) src)
{
    return qSharedPointerDynamicCast<X, T>(src.toStrongRef());
}

template <class X, extern(C++) class T>
Q_INLINE_TEMPLATE QSharedPointer<X> qSharedPointerConstCast(ref const(QSharedPointer<T>) src)
{
    X *ptr = const_cast<X *>(src.data()); // if you get an error in this line, the cast is invalid
    return QtSharedPointer::copyAndSetPointer(ptr, src);
}
template <class X, extern(C++) class T>
Q_INLINE_TEMPLATE QSharedPointer<X> qSharedPointerConstCast(ref const(QWeakPointer<T>) src)
{
...
template <class X, extern(C++) class T>
Q_INLINE_TEMPLATE
QWeakPointer<X> qWeakPointerCast(ref const(QSharedPointer<T>) src)
{
...
#ifndef QT_NO_QOBJECT
template <class X, extern(C++) class T>
Q_INLINE_TEMPLATE QSharedPointer<X> qSharedPointerObjectCast(ref const(QSharedPointer<T>) src)
{
    X *ptr = qobject_cast<X *>(src.data());
    return QtSharedPointer::copyAndSetPointer(ptr, src);
}
template <class X, extern(C++) class T>
Q_INLINE_TEMPLATE QSharedPointer<X> qSharedPointerObjectCast(ref const(QWeakPointer<T>) src)
{
...
qobject_cast(ref const(QSharedPointer<T>) src)
{
    return qSharedPointerObjectCast<typename QtSharedPointer::RemovePointer<X>::Type, T>(src);
}
template <class X, extern(C++) class T>
/+inline+/ QSharedPointer<typename QtSharedPointer::RemovePointer<X>::Type>
qobject_cast(ref const(QWeakPointer<T>) src)
{
    return qSharedPointerObjectCast<typename QtSharedPointer::RemovePointer<X>::Type, T>(src);
}
...
qWeakPointerFromVariant(ref const(QVariant) variant)
{
...
qSharedPointerFromVariant(ref const(QVariant) variant)
{
