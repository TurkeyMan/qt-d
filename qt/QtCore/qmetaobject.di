...
extern(C++) class export QMetaMethod
{
public:
...
private:
    ...
    uint handle;
    friend extern(C++) class QMetaMethodPrivate;
    friend struct QMetaObject;
    friend struct QMetaObjectPrivate;
    friend extern(C++) class QObject;
    friend bool operator==(ref const(QMetaMethod) m1, ref const(QMetaMethod) m2);
    friend bool operator!=(ref const(QMetaMethod) m1, ref const(QMetaMethod) m2);
}
Q_DECLARE_TYPEINFO(QMetaMethod, Q_MOVABLE_TYPE);

/+inline+/ bool operator==(ref const(QMetaMethod) m1, ref const(QMetaMethod) m2)
{ return m1.mobj == m2.mobj && m1.handle == m2.handle; }
/+inline+/ bool operator!=(ref const(QMetaMethod) m1, ref const(QMetaMethod) m2)
{ return !(m1 == m2); }

extern(C++) class export QMetaEnum
{
public:
...
extern(C++) class export QMetaProperty
{
public:
    QMetaProperty();
...
extern(C++) class export QMetaClassInfo
{
public:
