...
template <class T> extern(C++) class QSharedDataPointer;

extern(C++) class export QSharedData
{
public:
    mutable QAtomicInt ref;

    /+inline+/ QSharedData() : ref(0) { }
    /+inline+/ QSharedData(ref const(QSharedData) ) : ref(0) { }

private:
    // using the assignment operator would lead to corruption in the ref-counting
    QSharedData &operator=(ref const(QSharedData) );
}
...
public:
    ...
    /+inline+/ ref const(T) operator*() const { return *d; }
    /+inline+/ T *operator->() { detach(); return d; }
    ...
    /+inline+/ bool operator==(ref const(QSharedDataPointer<T>) other) const { return d == other.d; }
    /+inline+/ bool operator!=(ref const(QSharedDataPointer<T>) other) const { return d != other.d; }
    ...
    /+inline+/ QSharedDataPointer(ref const(QSharedDataPointer<T>) o) : d(o.d) { if (d) d->ref.ref(); }
    /+inline+/ QSharedDataPointer<T> & operator=(ref const(QSharedDataPointer<T>) o) {
        if (o.d != d) {
            if (o.d)
                o.d->ref.ref();
            T *old = d;
...
template <class T> extern(C++) class QExplicitlySharedDataPointer
{
public:
    typedef T Type;
    typedef T *pointer;
    ...
    /+inline+/ bool operator==(ref const(QExplicitlySharedDataPointer<T>) other) const { return d == other.d; }
    /+inline+/ bool operator!=(ref const(QExplicitlySharedDataPointer<T>) other) const { return d != other.d; }
    ...
    /+inline+/ QExplicitlySharedDataPointer(ref const(QExplicitlySharedDataPointer<T>) o) : d(o.d) { if (d) d->ref.ref(); }

    template<class X>
    /+inline+/ QExplicitlySharedDataPointer(ref const(QExplicitlySharedDataPointer<X>) o)
    ...
    /+inline+/ QExplicitlySharedDataPointer<T> & operator=(ref const(QExplicitlySharedDataPointer<T>) o) {
        if (o.d != d) {
            if (o.d)
                o.d->ref.ref();
            T *old = d;
...
template <class T>
Q_INLINE_TEMPLATE uint qHash(ref const(QSharedDataPointer<T>) ptr, uint seed = 0)
{
    return qHash(ptr.data(), seed);
}
template <class T>
Q_INLINE_TEMPLATE uint qHash(ref const(QExplicitlySharedDataPointer<T>) ptr, uint seed = 0)
{
    return qHash(ptr.data(), seed);
}
