...
public import QtCore.qbasictimer; // conceptual inheritance
public import QtCore.qobject;


extern(C++) class export QTimer : QObject
{
    mixin Q_OBJECT;
    mixin Q_PROPERTY!(bool, "singleShot", "READ", "isSingleShot", "WRITE", "setSingleShot");
    mixin Q_PROPERTY!(int, "interval", "READ", "interval", "WRITE", "setInterval");
    mixin Q_PROPERTY!(int, "remainingTime", "READ", "remainingTime");
    mixin Q_PROPERTY!(Qt.TimerType, "timerType", "READ", "timerType", "WRITE", "setTimerType");
    mixin Q_PROPERTY!(bool, "active", "READ", "isActive");
public:
