...
public import QtCore.qsocketnotifier;
public import QtCore.qreadwritelock;
public import QtCore.qlocale;

#ifndef QT_NO_SYSTEMLOCALE

extern(C++) class QBBSystemLocaleData : QObject
{
    mixin Q_OBJECT;
...
private:
    ...
    QString getCorrectFormat(ref const(QString) baseFormat, QLocale::FormatType typeFormat);
