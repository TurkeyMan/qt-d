    ...
    : QArrayData
{
    ...
    public:
        ...
        /+inline+/ iterator(ref const(iterator) o): i(o.i){} // #### Qt 6: remove, the implicit version is fine
    ...
    public:
        ...
        /+inline+/ const_iterator(ref const(const_iterator) o): i(o.i) {} // #### Qt 6: remove, the default version is fine
        /+inline+/ explicit const_iterator(ref const(iterator) o): i(o.i) {}
        /+inline+/ ref const(T) operator*() const { return *i; }
        /+inline+/ const(T)* operator->() const { return i; }
        /+inline+/ ref const(T) operator[](int j) const { return *(i + j); }
    ...
    extern(C++) class AlignmentDummy { QArrayData header; T data; }
...
namespace QtPrivate {
struct export QContainerImplHelper
{
