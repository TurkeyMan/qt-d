...
struct export QAbstractConcatenable
{
protected:
...
extern(C++) class QStringBuilder : QStringBuilderBase<QStringBuilder<A, B>, typename QtStringBuilder::ConvertToTypeHelper<typename QConcatenable<A>::ConvertTo, typename QConcatenable<B>::ConvertTo>::ConvertTo>
{
public:
    QStringBuilder(ref const(A) a_, ref const(B) b_) : a(a_), b(b_) {}
private:
...
template <>
extern(C++) class QStringBuilder <QString, QString> : QStringBuilderBase<QStringBuilder<QString, QString>, QString>
{
    public:
        QStringBuilder(ref const(QString) a_, ref const(QString) b_) : a(a_), b(b_) {}
        QStringBuilder(ref const(QStringBuilder) other) : a(other.a), b(other.b) {}
    ...
    private:
        QStringBuilder &operator=(ref const(QStringBuilder) ) Q_DECL_EQ_DELETE;
}

template <>
extern(C++) class QStringBuilder <QByteArray, QByteArray> : QStringBuilderBase<QStringBuilder<QByteArray, QByteArray>, QByteArray>
{
    public:
        QStringBuilder(ref const(QByteArray) a_, ref const(QByteArray) b_) : a(a_), b(b_) {}
        QStringBuilder(ref const(QStringBuilder) other) : a(other.a), b(other.b) {}
...
template <> struct QConcatenable<QString> : private QAbstractConcatenable
{
    ...
    typedef QString ConvertTo;
    enum { ExactSize = true }
    static int size(ref const(QString) a) { return a.size(); }
    static /+inline+/ void appendTo(ref const(QString) a, QChar *&out)
    {
        const int n = a.size();
...
template <> struct QConcatenable<QStringRef> : private QAbstractConcatenable
{
    ...
    typedef QString ConvertTo;
    enum { ExactSize = true }
    static int size(ref const(QStringRef) a) { return a.size(); }
    static /+inline+/ void appendTo(ref const(QStringRef) a, QChar *&out)
    {
        const int n = a.size();
        memcpy(out, reinterpret_cast<const char*>(a.constData()), sizeof(QChar) * n);
        out += n;
...
template <> struct QConcatenable<QByteArray> : private QAbstractConcatenable
{
    ...
    typedef QByteArray ConvertTo;
    enum { ExactSize = false }
    static int size(ref const(QByteArray) ba) { return ba.size(); }
#ifndef QT_NO_CAST_FROM_ASCII
    static /+inline+/ QT_ASCII_CAST_WARN void appendTo(ref const(QByteArray) ba, QChar *&out)
    {
        QAbstractConcatenable::convertFromAscii(ba.constData(), ba.size(), out);
    }
#endif
    static /+inline+/ void appendTo(ref const(QByteArray) ba, char *&out)
    {
...
struct QConcatenable< QStringBuilder<A, B> >
{
    ...
    static int size(ref const(type) p)
    {
        return QConcatenable<A>::size(p.a) + QConcatenable<B>::size(p.b);
    }
    template<typename T> static /+inline+/ void appendTo(ref const(type) p, T *&out)
    {
...
operator%(ref const(A) a, ref const(B) b)
{
