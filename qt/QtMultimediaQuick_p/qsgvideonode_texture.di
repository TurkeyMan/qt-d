...
public import qt.private.qsgvideonode_p;
public import qt.QtMultimedia.qvideosurfaceformat;
...
{
public:
    QSGVideoNode_Texture(ref const(QVideoSurfaceFormat) format);
    ~QSGVideoNode_Texture();

    /+virtual+/ QVideoFrame::PixelFormat pixelFormat() const {
        return m_format.pixelFormat();
    }
    void setCurrentFrame(ref const(QVideoFrame) frame);
...
public:
    ...
    QSGVideoNode *createNode(ref const(QVideoSurfaceFormat) format);
};
