...
public:
    ...
    QNetworkConfiguration(ref const(QNetworkConfiguration) other);
    QNetworkConfiguration &operator=(ref const(QNetworkConfiguration) other);
    ~QNetworkConfiguration();

    void swap(QNetworkConfiguration &other) { qSwap(d, other.d); }

    bool operator==(ref const(QNetworkConfiguration) other) const;
    /+inline+/ bool operator!=(ref const(QNetworkConfiguration) other) const
