...
public:
    ...
    bool bind(ref const(QHostAddress) address, quint16 port = 0, BindMode mode = DefaultForPlatform);
    bool bind(quint16 port = 0, BindMode mode = DefaultForPlatform);

    /+virtual+/ void connectToHost(ref const(QString) hostName, quint16 port, OpenMode mode = ReadWrite, NetworkLayerProtocol protocol = AnyIPProtocol);
    /+virtual+/ void connectToHost(ref const(QHostAddress) address, quint16 port, OpenMode mode = ReadWrite);
...
protected:
    ...
    void setLocalAddress(ref const(QHostAddress) address);
    void setPeerPort(quint16 port);
    void setPeerAddress(ref const(QHostAddress) address);
    void setPeerName(ref const(QString) name);
...
private:
    ...
    Q_PRIVATE_SLOT(d_func(), void _q_startConnecting(ref const(QHostInfo) ))
