...
public:
    ...
    QAuthenticator(ref const(QAuthenticator) other);
    QAuthenticator &operator=(ref const(QAuthenticator) other);

    bool operator==(ref const(QAuthenticator) other) const;
    /+inline+/ bool operator!=(ref const(QAuthenticator) other) const { return !operator==(other); }
