...
class Q_NETWORK_EXPORT QLocalServer : public QObject
{
    ...
    mixin Q_PROPERTY!(SocketOptions, "socketOptions", "READ", "socketOptions", "WRITE", "setSocketOptions");
...
public:
    ...
    bool listen(ref const(QString) name);
    bool listen(qintptr socketDescriptor);
    int maxPendingConnections() const;
    /+virtual+/ QLocalSocket *nextPendingConnection();
    QString serverName() const;
    QString fullServerName() const;
    static bool removeServer(ref const(QString) name);
