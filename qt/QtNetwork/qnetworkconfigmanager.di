...
public:
    ...
    QNetworkConfiguration configurationFromIdentifier(ref const(QString) identifier) const;
...
Q_SIGNALS:
    void configurationAdded(ref const(QNetworkConfiguration) config);
    void configurationRemoved(ref const(QNetworkConfiguration) config);
    void configurationChanged(ref const(QNetworkConfiguration) config);
