...
public import qt.QtNetwork.qsslsocket;
...
public:
    QSslConfiguration();
    QSslConfiguration(ref const(QSslConfiguration) other);
    ~QSslConfiguration();
    QSslConfiguration &operator=(ref const(QSslConfiguration) other);

    /+inline+/ void swap(QSslConfiguration &other)
    { qSwap(d, other.d); }

    bool operator==(ref const(QSslConfiguration) other) const;
    /+inline+/ bool operator!=(ref const(QSslConfiguration) other) const
    { return !(*this == other); }
    ...
    void setSessionTicket(ref const(QByteArray) sessionTicket);
    int sessionTicketLifeTimeHint() const;

    static QSslConfiguration defaultConfiguration();
    static void setDefaultConfiguration(ref const(QSslConfiguration) configuration);
