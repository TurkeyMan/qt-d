...
public:
    ...
    void connectToServer(ref const(QString) name, OpenMode openMode = ReadWrite);
    void disconnectFromServer();

    void setServerName(ref const(QString) name);
...
private:
    ...
    Q_PRIVATE_SLOT(d_func(), void _q_winError(ulong, ref const(QString) ))
#else
    Q_PRIVATE_SLOT(d_func(), void _q_stateChanged(QAbstractSocket::SocketState))
    Q_PRIVATE_SLOT(d_func(), void _q_error(QAbstractSocket::SocketError))
