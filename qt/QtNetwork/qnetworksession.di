...
public import qt.QtNetwork.qnetworkinterface;
...
public:
    ...
    explicit QNetworkSession(ref const(QNetworkConfiguration) connConfig, QObject *parent = 0);
    ...
    QVariant sessionProperty(ref const(QString) key) const;
    void setSessionProperty(ref const(QString) key, ref const(QVariant) value);
...
Q_SIGNALS:
    ...
    void preferredConfigurationChanged(ref const(QNetworkConfiguration) config, bool isSeamless);
