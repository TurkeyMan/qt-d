...
{
protected:
    QScriptClassPropertyIterator(ref const(QScriptValue) object);
...
protected:
    QScriptClassPropertyIterator(ref const(QScriptValue) object, QScriptClassPropertyIteratorPrivate &dd);
