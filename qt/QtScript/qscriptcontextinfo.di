...
public:
#ifndef QT_NO_DATASTREAM
    friend Q_SCRIPT_EXPORT QDataStream &operator<<(QDataStream &, ref const(QScriptContextInfo) );
    ...
    QScriptContextInfo(ref const(QScriptContextInfo) other);
    QScriptContextInfo();
    ~QScriptContextInfo();

    QScriptContextInfo &operator=(ref const(QScriptContextInfo) other);
    ...
    bool operator==(ref const(QScriptContextInfo) other) const;
    bool operator!=(ref const(QScriptContextInfo) other) const;
...
#ifndef QT_NO_DATASTREAM
Q_SCRIPT_EXPORT QDataStream &operator<<(QDataStream &, ref const(QScriptContextInfo) );
