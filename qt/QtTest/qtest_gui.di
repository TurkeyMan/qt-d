...
public import qt.QtTest.qtest;
public import qt.QtTest.qtestevent;
public import qt.QtTest.qtestmouse;
public import qt.QtTest.qtesttouch;
                    ...
                    const(char)* file, int line)
{
    ...
    return qCompare(*reinterpret_cast<void * ref const(*>()t1),
                   *reinterpret_cast<void * ref const(*>()t2), actual, expected, file, line);
}
