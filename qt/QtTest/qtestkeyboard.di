...
public import qt.QtWidgets.qapplication;
#endif

QT_BEGIN_NAMESPACE

Q_GUI_EXPORT void qt_handleKeyEvent(QWindow *w, QEvent::Type t, int k, Qt.KeyboardModifiers mods, ref const(QString)  text = QString(), bool autorep = false, ushort count = 1);
...
namespace QTest
{
    ...
    /+inline+/ static void keyClicks(QWidget *widget, ref const(QString) sequence,
                                 Qt.KeyboardModifiers modifier = Qt.NoModifier, int delay=-1)
    {
