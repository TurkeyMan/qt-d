...
#ifdef QT_GUI_LIB
public import qt.QtTest.qtestkeyboard;
public import qt.QtTest.qtestmouse;
#endif
...
{
public:
    /+inline+/ QTestKeyClicksEvent(ref const(QString) keys, Qt.KeyboardModifiers modifiers, int delay)
...
public:
    ...
    /+inline+/ QTestEventList(ref const(QTestEventList) other): QList<QTestEvent *>()
    ...
    /+inline+/ void addKeyClicks(ref const(QString) keys, Qt.KeyboardModifiers modifiers = Qt.NoModifier, int msecs = -1)
