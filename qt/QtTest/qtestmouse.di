...
Q_GUI_EXPORT void qt_handleMouseEvent(QWindow *w, ref const(QPointF)  local, ref const(QPointF)  global, Qt.MouseButtons b, Qt.KeyboardModifiers mods = Qt.NoModifier);
