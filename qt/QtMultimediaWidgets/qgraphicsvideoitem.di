...
class Q_MULTIMEDIAWIDGETS_EXPORT QGraphicsVideoItem : public QGraphicsObject, public QMediaBindableInterface
{
    ...
    mixin Q_PROPERTY!(QSizeF, "size", "READ", "size", "WRITE", "setSize");
    mixin Q_PROPERTY!(QSizeF, "nativeSize", "READ", "nativeSize", "NOTIFY", "nativeSizeChanged");
public:
...
Q_SIGNALS:
    void nativeSizeChanged(ref const(QSizeF) size);
