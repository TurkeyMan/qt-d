...
public:
    ...
    QGeoCoordinate(ref const(QGeoCoordinate) other);
    ~QGeoCoordinate();

    QGeoCoordinate &operator=(ref const(QGeoCoordinate) other);

    bool operator==(ref const(QGeoCoordinate) other) const;
    /+inline+/ bool operator!=(ref const(QGeoCoordinate) other) const {
    ...
    qreal distanceTo(ref const(QGeoCoordinate) other) const;
    qreal azimuthTo(ref const(QGeoCoordinate) other) const;
...
Q_POSITIONING_EXPORT QDebug operator<<(QDebug, ref const(QGeoCoordinate) );
#endif

#ifndef QT_NO_DATASTREAM
Q_POSITIONING_EXPORT QDataStream &operator<<(QDataStream &stream, ref const(QGeoCoordinate) coordinate);
