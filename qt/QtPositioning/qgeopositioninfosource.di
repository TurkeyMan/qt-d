...
public import qt.QtPositioning.QGeoPositionInfo;
...
class Q_POSITIONING_EXPORT QGeoPositionInfoSource : public QObject
{
    ...
    mixin Q_PROPERTY!(QString, "sourceName", "READ", "sourceName");
...
public:
    ...
    static QGeoPositionInfoSource *createSource(ref const(QString) sourceName, QObject *parent);
...
Q_SIGNALS:
    void positionUpdated(ref const(QGeoPositionInfo) update);
    void updateTimeout();
