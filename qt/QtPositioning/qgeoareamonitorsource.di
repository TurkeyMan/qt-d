...
public import qt.QtPositioning.QGeoAreaMonitorInfo;
...
public:
    ...
    static QGeoAreaMonitorSource *createSource(ref const(QString) sourceName, QObject *parent);
    ...
    /+virtual+/ bool startMonitoring(ref const(QGeoAreaMonitorInfo) monitor) = 0;
    /+virtual+/ bool stopMonitoring(ref const(QGeoAreaMonitorInfo) monitor) = 0;
    /+virtual+/ bool requestUpdate(ref const(QGeoAreaMonitorInfo) monitor, const(char)* signal) = 0;

    /+virtual+/ QList<QGeoAreaMonitorInfo> activeMonitors() const = 0;
    /+virtual+/ QList<QGeoAreaMonitorInfo> activeMonitors(ref const(QGeoShape) lookupArea) const = 0;

Q_SIGNALS:
    void areaEntered(ref const(QGeoAreaMonitorInfo) monitor, ref const(QGeoPositionInfo) update);
    void areaExited(ref const(QGeoAreaMonitorInfo) monitor, ref const(QGeoPositionInfo) update);
    void monitorExpired(ref const(QGeoAreaMonitorInfo) monitor);
