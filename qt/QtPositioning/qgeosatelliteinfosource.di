...
public import qt.QtPositioning.QGeoSatelliteInfo;
...
class Q_POSITIONING_EXPORT QGeoSatelliteInfoSource : public QObject
{
    ...
    mixin Q_PROPERTY!(int, "minimumUpdateInterval", "READ", "minimumUpdateInterval");
...
public:
    ...
    static QGeoSatelliteInfoSource *createSource(ref const(QString) sourceName, QObject *parent);
...
Q_SIGNALS:
    void satellitesInViewUpdated(ref const(QList<QGeoSatelliteInfo>) satellites);
    void satellitesInUseUpdated(ref const(QList<QGeoSatelliteInfo>) satellites);
    void requestTimeout();
