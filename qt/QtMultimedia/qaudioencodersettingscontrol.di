...
public:
    ...
    /+virtual+/ QString codecDescription(ref const(QString) codecName) const = 0;

    /+virtual+/ QList<int> supportedSampleRates(ref const(QAudioEncoderSettings) settings,
                                            bool *continuous = 0) const = 0;

    /+virtual+/ QAudioEncoderSettings audioSettings() const = 0;
    /+virtual+/ void setAudioSettings(ref const(QAudioEncoderSettings)) = 0;
