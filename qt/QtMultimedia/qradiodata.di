...
{
    mixin Q_OBJECT;
    mixin Q_PROPERTY!(QString, "stationId", "READ", "stationId", "NOTIFY", "stationIdChanged");
    mixin Q_PROPERTY!(ProgramType, "programType", "READ", "programType", "NOTIFY", "programTypeChanged");
    mixin Q_PROPERTY!(QString, "programTypeName", "READ", "programTypeName", "NOTIFY", "programTypeNameChanged");
    mixin Q_PROPERTY!(QString, "stationName", "READ", "stationName", "NOTIFY", "stationNameChanged");
    mixin Q_PROPERTY!(QString, "radioText", "READ", "radioText", "NOTIFY", "radioTextChanged");
