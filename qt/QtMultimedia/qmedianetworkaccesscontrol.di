...
public:
    ...
    /+virtual+/ void setConfigurations(ref const(QList<QNetworkConfiguration>) configuration) = 0;
    /+virtual+/ QNetworkConfiguration currentConfiguration() const = 0;

Q_SIGNALS:
    void configurationChanged(ref const(QNetworkConfiguration) configuration);
