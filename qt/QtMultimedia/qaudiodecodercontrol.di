...
public import qt.QtMultimedia.qaudiodecoder;
...
public:
    ...
    /+virtual+/ void setSourceFilename(ref const(QString) fileName) = 0;
    ...
    /+virtual+/ void setAudioFormat(ref const(QAudioFormat) format) = 0;
