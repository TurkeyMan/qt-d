...
public import qt.QtMultimedia.qcameraimagecapture;
...
public:
    ...
    /+virtual+/ int capture(ref const(QString) fileName) = 0;
...
Q_SIGNALS:
    ...
    void imageAvailable(int id, ref const(QVideoFrame) buffer);
    void imageSaved(int id, ref const(QString) fileName);

    void error(int id, int error, ref const(QString) errorString);
