...
public:
    ...
    /+virtual+/ QString inputDescription(ref const(QString) name) const = 0;
    /+virtual+/ QString defaultInput() const = 0;
    /+virtual+/ QString activeInput() const = 0;

public Q_SLOTS:
    /+virtual+/ void setActiveInput(ref const(QString) name) = 0;

Q_SIGNALS:
    void activeInputChanged(ref const(QString) name);
