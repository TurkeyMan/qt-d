...
{
    mixin Q_OBJECT;
    mixin Q_PROPERTY!(QString, "audioInput", "READ", "audioInput", "WRITE", "setAudioInput", "NOTIFY", "audioInputChanged");
public:
    ...
    QString audioInputDescription(ref const(QString) name) const;

    QString audioInput() const;

public Q_SLOTS:
    void setAudioInput(ref const(QString) name);

Q_SIGNALS:
    void audioInputChanged(ref const(QString) name);
