...
class Q_MULTIMEDIA_EXPORT QRadioTuner : public QMediaObject
{
    ...
    mixin Q_PROPERTY!(Band, "band", "READ", "band", "WRITE", "setBand", "NOTIFY", "bandChanged");
    mixin Q_PROPERTY!(int, "frequency", "READ", "frequency", "WRITE", "setFrequency", "NOTIFY", "frequencyChanged");
    mixin Q_PROPERTY!(bool, "stereo", "READ", "isStereo", "NOTIFY", "stereoStatusChanged");
    mixin Q_PROPERTY!(StereoMode, "stereoMode", "READ", "stereoMode", "WRITE", "setStereoMode");
    mixin Q_PROPERTY!(int, "signalStrength", "READ", "signalStrength", "NOTIFY", "signalStrengthChanged");
    ...
    mixin Q_PROPERTY!(bool, "searching", "READ", "isSearching", "NOTIFY", "searchingChanged");
    mixin Q_PROPERTY!(bool, "antennaConnected", "READ", "isAntennaConnected", "NOTIFY", "antennaConnectedChanged");
