...
public:
    ...
    /+virtual+/ QString imageCodecDescription(ref const(QString) codecName) const = 0;

    /+virtual+/ QList<QSize> supportedResolutions(ref const(QImageEncoderSettings) settings,
                                              bool *continuous = 0) const = 0;

    /+virtual+/ QImageEncoderSettings imageSettings() const = 0;
    /+virtual+/ void setImageSettings(ref const(QImageEncoderSettings) settings) = 0;
