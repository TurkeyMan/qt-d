...
public:
    ...
    /+virtual+/ bool isParameterValueSupported(ProcessingParameter parameter, ref const(QVariant) value) const = 0;
    /+virtual+/ QVariant parameter(ProcessingParameter parameter) const = 0;
    /+virtual+/ void setParameter(ProcessingParameter parameter, ref const(QVariant) value) = 0;
