...
public:
    ...
    /+virtual+/ QList<QSize> supportedResolutions(ref const(QVideoEncoderSettings) settings,
                                              bool *continuous = 0) const = 0;

    /+virtual+/ QList<qreal> supportedFrameRates(ref const(QVideoEncoderSettings) settings,
                                             bool *continuous = 0) const = 0;

    /+virtual+/ QStringList supportedVideoCodecs() const = 0;
    /+virtual+/ QString videoCodecDescription(ref const(QString) codecName) const = 0;

    /+virtual+/ QVideoEncoderSettings videoSettings() const = 0;
    /+virtual+/ void setVideoSettings(ref const(QVideoEncoderSettings) settings) = 0;
