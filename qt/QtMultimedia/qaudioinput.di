...
public:
    explicit QAudioInput(ref const(QAudioFormat) format = QAudioFormat(), QObject *parent = 0);
    explicit QAudioInput(ref const(QAudioDeviceInfo) audioDeviceInfo, ref const(QAudioFormat) format = QAudioFormat(), QObject *parent = 0);
    ~QAudioInput();
