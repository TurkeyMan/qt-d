...
public import qt.QtMultimedia.qaudiobuffer;
...
{
    mixin Q_OBJECT;
    mixin Q_PROPERTY!(QString, "sourceFilename", "READ", "sourceFilename", "WRITE", "setSourceFilename", "NOTIFY", "sourceChanged");
    mixin Q_PROPERTY!(State, "state", "READ", "state", "NOTIFY", "stateChanged");
    mixin Q_PROPERTY!(QString, "error", "READ", "errorString");
    mixin Q_PROPERTY!(bool, "bufferAvailable", "READ", "bufferAvailable", "NOTIFY", "bufferAvailableChanged");
...
public:
    ...
    static QMultimedia::SupportEstimate hasSupport(ref const(QString) mimeType, ref const(QStringList) codecs = QStringList());

    State state() const;

    QString sourceFilename() const;
    void setSourceFilename(ref const(QString) fileName);

    QIODevice* sourceDevice() const;
    void setSourceDevice(QIODevice *device);

    QAudioFormat audioFormat() const;
    void setAudioFormat(ref const(QAudioFormat) format);
...
Q_SIGNALS:
    ...
    void formatChanged(ref const(QAudioFormat) format);
