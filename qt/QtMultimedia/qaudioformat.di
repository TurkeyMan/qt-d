...
public:
    ...
    QAudioFormat();
    QAudioFormat(ref const(QAudioFormat) other);
    ~QAudioFormat();

    QAudioFormat& operator=(ref const(QAudioFormat) other);
    bool operator==(ref const(QAudioFormat) other) const;
    bool operator!=(ref const(QAudioFormat) other) const;
...
Q_MULTIMEDIA_EXPORT QDebug operator<<(QDebug, ref const(QAudioFormat) );
