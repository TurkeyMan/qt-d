...
public:
    ...
    QPlaceMatchRequest();
    QPlaceMatchRequest(ref const(QPlaceMatchRequest) other);


    QPlaceMatchRequest &operator=(ref const(QPlaceMatchRequest) other);

    bool operator==(ref const(QPlaceMatchRequest) other) const;
    bool operator!=(ref const(QPlaceMatchRequest) other) const;
