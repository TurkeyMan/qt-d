...
protected:
    void setResults(ref const(QList<QPlaceSearchResult>) results);
    void setRequest(ref const(QPlaceSearchRequest) request);
    void setPreviousPageRequest(ref const(QPlaceSearchRequest) previous);
    void setNextPageRequest(ref const(QPlaceSearchRequest) next);
