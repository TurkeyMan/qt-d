...
public:
    ...
    QGeoManeuver();
    QGeoManeuver(ref const(QGeoManeuver) other);
    ~QGeoManeuver();

    QGeoManeuver &operator= (ref const(QGeoManeuver) other);

    bool operator== (ref const(QGeoManeuver) other) const;
    bool operator!= (ref const(QGeoManeuver) other) const;

    bool isValid() const;

    void setPosition(ref const(QGeoCoordinate) position);
    QGeoCoordinate position() const;

    void setInstructionText(ref const(QString) instructionText);
    ...
    void setWaypoint(ref const(QGeoCoordinate) coordinate);
