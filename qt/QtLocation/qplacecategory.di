...
public:
    QPlaceCategory();
    QPlaceCategory(ref const(QPlaceCategory) other);

    /+virtual+/ ~QPlaceCategory();

    QPlaceCategory &operator=(ref const(QPlaceCategory) other);

    bool operator==(ref const(QPlaceCategory) other) const;
    bool operator!=(ref const(QPlaceCategory) other) const {
        return !(other == *this);
    }

    QString categoryId() const;
    void setCategoryId(ref const(QString) identifier);
