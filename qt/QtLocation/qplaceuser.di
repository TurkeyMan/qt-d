...
public:
    QPlaceUser();
    QPlaceUser(ref const(QPlaceUser) other);
    ~QPlaceUser();

    QPlaceUser &operator=(ref const(QPlaceUser) other);

    bool operator==(ref const(QPlaceUser) other) const;
    bool operator!=(ref const(QPlaceUser) other) const {
        return !(other == *this);
    }

    QString userId() const;
    void setUserId(ref const(QString) identifier);
