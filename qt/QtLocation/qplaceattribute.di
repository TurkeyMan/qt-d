...
public:
    ...
    QPlaceAttribute();
    QPlaceAttribute(ref const(QPlaceAttribute) other);
    /+virtual+/ ~QPlaceAttribute();

    QPlaceAttribute &operator=(ref const(QPlaceAttribute) other);

    bool operator==(ref const(QPlaceAttribute) other) const;
    bool operator!=(ref const(QPlaceAttribute) other) const;
