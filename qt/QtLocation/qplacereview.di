...
public:
    QPlaceReview();
#ifdef Q_QDOC
    QPlaceReview(ref const(QPlaceContent) other);
#else
    ...
    void setDateTime(ref const(QDateTime) dt);
    QString text() const;
    void setText(ref const(QString) text);
    QString language() const;
    void setLanguage(ref const(QString) data);

    qreal rating() const;
    void setRating(qreal data);
    QString reviewId() const;
    void setReviewId(ref const(QString) identifier);
    QString title() const;
    void setTitle(ref const(QString) data);
