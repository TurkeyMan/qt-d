...
protected:
    void setContent(ref const(QPlaceContent::Collection) content);
    void setTotalCount(int total);
    void setRequest(ref const(QPlaceContentRequest) request);
    void setPreviousPageRequest(ref const(QPlaceContentRequest) previous);
    void setNextPageRequest(ref const(QPlaceContentRequest) next);
