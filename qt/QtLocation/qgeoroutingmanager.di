...
public:
    ...
    QGeoRouteReply *calculateRoute(ref const(QGeoRouteRequest) request);
    QGeoRouteReply *updateRoute(ref const(QGeoRoute) route, ref const(QGeoCoordinate) position);
