...
public import qt.QtLocation.QPlaceSupplier;
...
public:
    QPlaceImage();
#ifdef Q_QDOC
    QPlaceImage(ref const(QPlaceContent) other);
#else
    ...
    void setImageId(ref const(QString) identifier);

    QString mimeType() const;
    void setMimeType(ref const(QString) data);
