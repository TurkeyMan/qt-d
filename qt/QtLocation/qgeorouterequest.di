...
public import qt.QtCore.QExplicitlySharedDataPointer;
...
public:
    ...
    explicit QGeoRouteRequest(ref const(QList<QGeoCoordinate>) waypoints = QList<QGeoCoordinate>());
    QGeoRouteRequest(ref const(QGeoCoordinate) origin,
                     ref const(QGeoCoordinate) destination);
    QGeoRouteRequest(ref const(QGeoRouteRequest) other);

    ~QGeoRouteRequest();

    QGeoRouteRequest &operator= (ref const(QGeoRouteRequest) other);

    bool operator == (ref const(QGeoRouteRequest) other) const;
    bool operator != (ref const(QGeoRouteRequest) other) const;

    void setWaypoints(ref const(QList<QGeoCoordinate>) waypoints);
    QList<QGeoCoordinate> waypoints() const;

    void setExcludeAreas(ref const(QList<QGeoRectangle>) areas);
