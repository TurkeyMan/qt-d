...
public import qt.QtLocation.placemacro;
public import qt.QtLocation.QPlaceCategory;
public import qt.QtLocation.QLocation;
...
public:
    ...
    QPlaceSearchRequest();
    QPlaceSearchRequest(ref const(QPlaceSearchRequest) other);


    QPlaceSearchRequest &operator=(ref const(QPlaceSearchRequest) other);

    bool operator==(ref const(QPlaceSearchRequest) other) const;
    bool operator!=(ref const(QPlaceSearchRequest) other) const;

    ~QPlaceSearchRequest();

    QString searchTerm() const;
    void setSearchTerm(ref const(QString) term);
    ...
    void setSearchArea(ref const(QGeoShape) area);

    QString recommendationId() const;
    void setRecommendationId(ref const(QString) recommendationId);

    QVariant searchContext() const;
    void setSearchContext(ref const(QVariant) context);
