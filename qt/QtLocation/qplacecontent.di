...
#define Q_DECLARE_CONTENT_COPY_CTOR(Class) \
    Class(ref const(QPlaceContent) other);
...
public:
    ...
    QPlaceContent();
    QPlaceContent(ref const(QPlaceContent) other);
    /+virtual+/ ~QPlaceContent();

    QPlaceContent &operator=(ref const(QPlaceContent) other);

    bool operator==(ref const(QPlaceContent) other) const;
    bool operator!=(ref const(QPlaceContent) other) const;
    ...
    void setUser(ref const(QPlaceUser) user);
