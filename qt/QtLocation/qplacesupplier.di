...
public:
    QPlaceSupplier();
    QPlaceSupplier(ref const(QPlaceSupplier) other);
    ~QPlaceSupplier();

    QPlaceSupplier &operator=(ref const(QPlaceSupplier) other);

    bool operator==(ref const(QPlaceSupplier) other) const;
    bool operator!=(ref const(QPlaceSupplier) other) const {
        return !(other == *this);
    }

    QString name() const;
    void setName(ref const(QString) data);

    QString supplierId() const;
    void setSupplierId(ref const(QString) identifier);

    QUrl url() const;
    void setUrl(ref const(QUrl) data);
