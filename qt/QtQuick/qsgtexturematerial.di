...
public import QtQuick.qsgtexture;

extern(C++) class Q_QUICK_EXPORT QSGOpaqueTextureMaterial : QSGMaterial
{
public:
...
extern(C++) class Q_QUICK_EXPORT QSGTextureMaterial : QSGOpaqueTextureMaterial
{
public:
    /+virtual+/ QSGMaterialType *type() const;
    /+virtual+/ QSGMaterialShader *createShader() const;
