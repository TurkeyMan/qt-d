...
public import QtCore.QRectF;

extern(C++) class QSGGeometryData;

extern(C++) class Q_QUICK_EXPORT QSGGeometry
{
public:
    ...
    static ref const(AttributeSet) defaultAttributes_Point2D();
    static ref const(AttributeSet) defaultAttributes_TexturedPoint2D();
    static ref const(AttributeSet) defaultAttributes_ColoredPoint2D();
    ...
    QSGGeometry(ref const(QSGGeometry::AttributeSet) attribs,
                int vertexCount,
                int indexCount = 0,
    ...
    static void updateRectGeometry(QSGGeometry *g, ref const(QRectF) rect);
    static void updateTexturedRectGeometry(QSGGeometry *g, ref const(QRectF) rect, ref const(QRectF) sourceRect);
...
private:
    friend extern(C++) class QSGGeometryData;

    int m_drawing_mode;
    int m_vertex_count;
    int m_index_count;
    int m_index_type;
    ref const(AttributeSet) m_attributes;
    void *m_data;
