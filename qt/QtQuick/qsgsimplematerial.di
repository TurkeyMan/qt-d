...
public import QtQuick.qsgmaterial;

template <typename State>
extern(C++) class QSGSimpleMaterialShader : QSGMaterialShader
{
public:
    void initialize() {
    ...
    void updateState(ref const(RenderState) state, QSGMaterial *newMaterial, QSGMaterial *oldMaterial);
...
template <typename State>
extern(C++) class QSGSimpleMaterial : QSGMaterial
{
public:
#ifndef qdoc
    QSGSimpleMaterial(ref const(State) aState, PtrShaderCreateFunc func)
        : m_state(aState)
        , m_func(func)
    {
    }
...
template <typename State>
extern(C++) class QSGSimpleMaterialComparableMaterial : QSGSimpleMaterial<State>
{

public:
    QSGSimpleMaterialComparableMaterial(ref const(State) state, PtrShaderCreateFunc func)
...
template <typename State>
Q_INLINE_TEMPLATE void QSGSimpleMaterialShader<State>::updateState(ref const(RenderState) state, QSGMaterial *newMaterial, QSGMaterial *oldMaterial)
{
