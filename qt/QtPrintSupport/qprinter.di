...
public import qt.QtGui.qpagedpaintdevice;
public import qt.QtGui.qpagelayout;
public import qt.QtPrintSupport.qtprintsupportglobal;
...
public:
    ...
    explicit QPrinter(ref const(QPrinterInfo) printer, PrinterMode mode = ScreenResolution);
    ~QPrinter();
    ...
    void setPrinterName(ref const(QString) );
    QString printerName() const;

    bool isValid() const;

    void setOutputFileName(ref const(QString) );
    QString outputFileName()const;

    void setPrintProgram(ref const(QString) );
    QString printProgram() const;

    void setDocName(ref const(QString) );
    QString docName() const;

    void setCreator(ref const(QString) );
    QString creator() const;

#ifdef Q_QDOC
    bool setPageLayout(ref const(QPageLayout) pageLayout);
    bool setPageSize(ref const(QPageSize) pageSize);
    bool setPageOrientation(QPageLayout::Orientation orientation);
    bool setPageMargins(ref const(QMarginsF) margins);
    bool setPageMargins(ref const(QMarginsF) margins, QPageLayout::Unit units);
    ...
    void setPageSizeMM(ref const(QSizeF) size);

    void setPaperSize(PaperSize);
    PaperSize paperSize() const;

    void setPaperSize(ref const(QSizeF) paperSize, Unit unit);
    QSizeF paperSize(Unit unit) const;

    void setPaperName(ref const(QString) paperName);
    ...
    void setPrinterSelectionOption(ref const(QString) );
    ...
    void setMargins(ref const(Margins) m);
