...
public import qt.QtSensors.qsensorgesture;
public import qt.QtSensors.qsensorgesturerecognizer;
...
public:
    ...
    QStringList recognizerSignals(ref const(QString) recognizerId) const;

    static QSensorGestureRecognizer *sensorGestureRecognizer(ref const(QString) id);
