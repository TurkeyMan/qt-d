...
public import qt.QtSensors.qsensorsglobal;
...
class Q_SENSORS_EXPORT QSensor : public QObject
{
    ...
    mixin Q_PROPERTY!(QByteArray, "identifier", "READ", "identifier", "WRITE", "setIdentifier");
    mixin Q_PROPERTY!(QByteArray, "type", "READ", "type");
    mixin Q_PROPERTY!(bool, "connectedToBackend", "READ", "isConnectedToBackend");
    mixin Q_PROPERTY!(qrangelist, "availableDataRates", "READ", "availableDataRates");
    mixin Q_PROPERTY!(int, "dataRate", "READ", "dataRate", "WRITE", "setDataRate", "NOTIFY", "dataRateChanged");
    mixin Q_PROPERTY!(QSensorReading*, "reading", "READ", "reading", "NOTIFY", "readingChanged");
    mixin Q_PROPERTY!(bool, "busy", "READ", "isBusy");
    mixin Q_PROPERTY!(bool, "active", "READ", "isActive", "WRITE", "setActive", "NOTIFY", "activeChanged");
    mixin Q_PROPERTY!(qoutputrangelist, "outputRanges", "READ", "outputRanges");
    mixin Q_PROPERTY!(int, "outputRange", "READ", "outputRange", "WRITE", "setOutputRange");
    mixin Q_PROPERTY!(QString, "description", "READ", "description");
    mixin Q_PROPERTY!(int, "error", "READ", "error", "NOTIFY", "sensorError");
    mixin Q_PROPERTY!(bool, "alwaysOn", "READ", "isAlwaysOn", "WRITE", "setAlwaysOn", "NOTIFY", "alwaysOnChanged");
    mixin Q_PROPERTY!(bool, "skipDuplicates", "READ", "skipDuplicates", "WRITE", "setSkipDuplicates", "NOTIFY", "skipDuplicatesChanged");
    mixin Q_PROPERTY!(AxesOrientationMode, "axesOrientationMode", "READ", "axesOrientationMode", "WRITE", "setAxesOrientationMode", "NOTIFY", "axesOrientationModeChanged");
    mixin Q_PROPERTY!(int, "currentOrientation", "READ", "currentOrientation", "NOTIFY", "currentOrientationChanged");
    mixin Q_PROPERTY!(int, "userOrientation", "READ", "userOrientation", "WRITE", "setUserOrientation", "NOTIFY", "userOrientationChanged");
    mixin Q_PROPERTY!(int, "maxBufferSize", "READ", "maxBufferSize", "NOTIFY", "maxBufferSizeChanged");
    mixin Q_PROPERTY!(int, "efficientBufferSize", "READ", "efficientBufferSize", "NOTIFY", "efficientBufferSizeChanged");
    mixin Q_PROPERTY!(int, "bufferSize", "READ", "bufferSize", "WRITE", "setBufferSize", "NOTIFY", "bufferSizeChanged");
public:
    enum Feature {
        Buffering,
        AlwaysOn,
    ...
    explicit QSensor(ref const(QByteArray) type, QObject *parent = 0);
    /+virtual+/ ~QSensor();

    QByteArray identifier() const;
    void setIdentifier(ref const(QByteArray) identifier);
    ...
    static QList<QByteArray> sensorsForType(ref const(QByteArray) type);
    static QByteArray defaultSensorForType(ref const(QByteArray) type);
...
protected:
    explicit QSensor(ref const(QByteArray) type, QSensorPrivate &dd, QObject* parent = 0);
...
class Q_SENSORS_EXPORT QSensorReading : public QObject
{
    ...
    mixin Q_OBJECT;
    mixin Q_PROPERTY!(quint64, "timestamp", "READ", "timestamp");
public:
