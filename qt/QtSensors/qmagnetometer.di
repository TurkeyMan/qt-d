...
{
    mixin Q_OBJECT;
    mixin Q_PROPERTY!(qreal, "x", "READ", "x");
    mixin Q_PROPERTY!(qreal, "y", "READ", "y");
    mixin Q_PROPERTY!(qreal, "z", "READ", "z");
    mixin Q_PROPERTY!(qreal, "calibrationLevel", "READ", "calibrationLevel");
...
{
    mixin Q_OBJECT;
    mixin Q_PROPERTY!(bool, "returnGeoValues", "READ", "returnGeoValues", "WRITE", "setReturnGeoValues", "NOTIFY", "returnGeoValuesChanged");
public:
