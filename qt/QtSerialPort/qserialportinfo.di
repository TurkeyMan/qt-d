...
public:
    QSerialPortInfo();
    explicit QSerialPortInfo(ref const(QSerialPort) port);
    explicit QSerialPortInfo(ref const(QString) name);
    QSerialPortInfo(ref const(QSerialPortInfo) other);
    ~QSerialPortInfo();

    QSerialPortInfo& operator=(ref const(QSerialPortInfo) other);
...
private:
    QSerialPortInfo(ref const(QSerialPortInfoPrivate) dd);
