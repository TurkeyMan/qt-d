...
public import qt.QtSerialPort.qserialportglobal;
...
class Q_SERIALPORT_EXPORT QSerialPort : public QIODevice
{
    ...
    mixin Q_PROPERTY!(qint32, "baudRate", "READ", "baudRate", "WRITE", "setBaudRate", "NOTIFY", "baudRateChanged");
    mixin Q_PROPERTY!(DataBits, "dataBits", "READ", "dataBits", "WRITE", "setDataBits", "NOTIFY", "dataBitsChanged");
    mixin Q_PROPERTY!(Parity, "parity", "READ", "parity", "WRITE", "setParity", "NOTIFY", "parityChanged");
    mixin Q_PROPERTY!(StopBits, "stopBits", "READ", "stopBits", "WRITE", "setStopBits", "NOTIFY", "stopBitsChanged");
    mixin Q_PROPERTY!(FlowControl, "flowControl", "READ", "flowControl", "WRITE", "setFlowControl", "NOTIFY", "flowControlChanged");
#if QT_DEPRECATED_SINCE(5, 2)
    mixin Q_PROPERTY!(DataErrorPolicy, "dataErrorPolicy", "READ", "dataErrorPolicy", "WRITE", "setDataErrorPolicy", "NOTIFY", "dataErrorPolicyChanged");
#endif
    mixin Q_PROPERTY!(bool, "dataTerminalReady", "READ", "isDataTerminalReady", "WRITE", "setDataTerminalReady", "NOTIFY", "dataTerminalReadyChanged");
    mixin Q_PROPERTY!(bool, "requestToSend", "READ", "isRequestToSend", "WRITE", "setRequestToSend", "NOTIFY", "requestToSendChanged");
    mixin Q_PROPERTY!(SerialPortError, "error", "READ", "error", "RESET", "clearError", "NOTIFY", "error");
#if QT_DEPRECATED_SINCE(5, 3)
    mixin Q_PROPERTY!(bool, "settingsRestoredOnClose", "READ", "settingsRestoredOnClose", "WRITE", "setSettingsRestoredOnClose", "NOTIFY", "settingsRestoredOnCloseChanged");
#endif
...
#pragma deprecated(ReceivedDataSignal)
    ...
    explicit QSerialPort(ref const(QString) name, QObject *parent = Q_NULLPTR);
    explicit QSerialPort(ref const(QSerialPortInfo) info, QObject *parent = Q_NULLPTR);
    /+virtual+/ ~QSerialPort();

    void setPortName(ref const(QString) name);
    QString portName() const;

    void setPort(ref const(QSerialPortInfo) info);
...
private:
    void setError(QSerialPort::SerialPortError error, ref const(QString) errorString = QString());
