...
public import qt.QtCore.QFileInfo;
public import qt.QtNfc.QNdefMessage;
public import qt.QtNfc.QNearFieldShareManager;
...
public:
    ...
    bool share(ref const(QNdefMessage) message);
    bool share(ref const(QList<QFileInfo>) files);
    void cancel();
