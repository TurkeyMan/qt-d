...
public import qt.QtWidgets.qlayoutitem;
...
class Q_WIDGETS_EXPORT QLayout : public QObject, public QLayoutItem
{
    ...
    mixin Q_PROPERTY!(SizeConstraint, "sizeConstraint", "READ", "sizeConstraint", "WRITE", "setSizeConstraint");
public:
    enum SizeConstraint {
...
protected:
    ...
    QRect alignmentRect(ref const(QRect)) const;
protected:
...
public import qt.QtWidgets.qboxlayout;
public import qt.QtWidgets.qgridlayout;
