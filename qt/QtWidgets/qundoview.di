...
class Q_WIDGETS_EXPORT QUndoView : public QListView
{
    ...
    mixin Q_PROPERTY!(QString, "emptyLabel", "READ", "emptyLabel", "WRITE", "setEmptyLabel");
    mixin Q_PROPERTY!(QIcon, "cleanIcon", "READ", "cleanIcon", "WRITE", "setCleanIcon");
...
public:
    ...
    void setEmptyLabel(ref const(QString) label);
    QString emptyLabel() const;

    void setCleanIcon(ref const(QIcon) icon);
