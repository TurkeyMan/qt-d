...
class Q_WIDGETS_EXPORT QMessageBox : public QDialog
{
    ...
    mixin Q_PROPERTY!(Icon, "icon", "READ", "icon", "WRITE", "setIcon");
    mixin Q_PROPERTY!(QPixmap, "iconPixmap", "READ", "iconPixmap", "WRITE", "setIconPixmap");
    mixin Q_PROPERTY!(Qt.TextFormat, "textFormat", "READ", "textFormat", "WRITE", "setTextFormat");
    mixin Q_PROPERTY!(StandardButtons, "standardButtons", "READ", "standardButtons", "WRITE", "setStandardButtons");
#ifndef QT_NO_TEXTEDIT
    mixin Q_PROPERTY!(QString, "detailedText", "READ", "detailedText", "WRITE", "setDetailedText");
#endif
    mixin Q_PROPERTY!(QString, "informativeText", "READ", "informativeText", "WRITE", "setInformativeText");
...
public:
    ...
    QMessageBox(Icon icon, ref const(QString) title, ref const(QString) text,
                StandardButtons buttons = NoButton, QWidget *parent = 0,
                Qt.WindowFlags flags = Qt.Dialog | Qt.MSWindowsFixedSizeDialogHint);
    ~QMessageBox();

    void addButton(QAbstractButton *button, ButtonRole role);
    QPushButton *addButton(ref const(QString) text, ButtonRole role);
    ...
    void setIconPixmap(ref const(QPixmap) pixmap);
    ...
    static StandardButton information(QWidget *parent, ref const(QString) title,
         ref const(QString) text, StandardButtons buttons = Ok,
         StandardButton defaultButton = NoButton);
    static StandardButton question(QWidget *parent, ref const(QString) title,
         ref const(QString) text, StandardButtons buttons = StandardButtons(Yes | No),
         StandardButton defaultButton = NoButton);
    ...
    static void aboutQt(QWidget *parent, ref const(QString) title = QString());

    // the following functions are obsolete:

    QMessageBox(ref const(QString) title, ref const(QString) text, Icon icon,
    ...
    static int information(QWidget *parent, ref const(QString) title,
                           ...
                           ref const(QString) button1Text = QString(),
                           ref const(QString) button2Text = QString(),
                           int defaultButtonNumber = 0,
                           int escapeButtonNumber = -1);
    /+inline+/ static StandardButton information(QWidget *parent, ref const(QString) title,
                                  ref const(QString) text,
    ...
    static int question(QWidget *parent, ref const(QString) title,
                        ...
                        int defaultButtonNumber = 0,
                        int escapeButtonNumber = -1);
    /+inline+/ static int question(QWidget *parent, ref const(QString) title,
                               ref const(QString) text,
    ...
    static int warning(QWidget *parent, ref const(QString) title,
                       ...
                       int defaultButtonNumber = 0,
                       int escapeButtonNumber = -1);
    /+inline+/ static int warning(QWidget *parent, ref const(QString) title,
                              ref const(QString) text,
                              StandardButton button0, StandardButton button1)
    ...
    static int critical(QWidget *parent, ref const(QString) title,
                        ...
                        int defaultButtonNumber = 0,
                        int escapeButtonNumber = -1);
    /+inline+/ static int critical(QWidget *parent, ref const(QString) title,
                               ref const(QString) text,
                               StandardButton button0, StandardButton button1)
    { return critical(parent, title, text, StandardButtons(button0), button1); }

    QString buttonText(int button) const;
    void setButtonText(int button, ref const(QString) text);

    QString informativeText() const;
    void setInformativeText(ref const(QString) text);

#ifndef QT_NO_TEXTEDIT
    QString detailedText() const;
    void setDetailedText(ref const(QString) text);
#endif

    void setWindowTitle(ref const(QString) title);
