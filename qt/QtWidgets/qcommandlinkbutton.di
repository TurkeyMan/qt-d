...
public import qt.QtWidgets.qpushbutton;
...
class Q_WIDGETS_EXPORT QCommandLinkButton: public QPushButton
{
    ...
    mixin Q_PROPERTY!(bool, "flat", "READ", "isFlat", "WRITE", "setFlat", "DESIGNABLE", "false");

public:
    explicit QCommandLinkButton(QWidget *parent=0);
    explicit QCommandLinkButton(ref const(QString) text, QWidget *parent=0);
    explicit QCommandLinkButton(ref const(QString) text, ref const(QString) description, QWidget *parent=0);
    ~QCommandLinkButton();
