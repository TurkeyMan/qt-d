...
public import qt.QtWidgets.qheaderview;
...
private:
    ...
    /+inline+/ int logicalIndex(ref const(QModelIndex) index) const;
...
{
public:
    QAccessibleTableCell(QAbstractItemView *view, ref const(QModelIndex) m_index, QAccessible::Role role);
    ...
    /+virtual+/ void doAction(ref const(QString) actionName) Q_DECL_OVERRIDE;
    /+virtual+/ QStringList keyBindingsForAction(ref const(QString) actionName) const Q_DECL_OVERRIDE;
...
public:
    ...
    void setText(QAccessible::Text, ref const(QString) ) Q_DECL_OVERRIDE {}
