...
class Q_WIDGETS_EXPORT QToolBar : public QWidget
{
    ...
    mixin Q_PROPERTY!(QSize, "iconSize", "READ", "iconSize", "WRITE", "setIconSize", "NOTIFY", "iconSizeChanged");
    Q_PROPERTY(Qt.ToolButtonStyle toolButtonStyle READ toolButtonStyle WRITE setToolButtonStyle
               NOTIFY toolButtonStyleChanged)
    mixin Q_PROPERTY!(bool, "floating", "READ", "isFloating");
    mixin Q_PROPERTY!(bool, "floatable", "READ", "isFloatable", "WRITE", "setFloatable");

public:
    explicit QToolBar(ref const(QString) title, QWidget *parent = 0);
    ...
    QAction *addAction(ref const(QString) text, const(QObject)* receiver, const(char)* member);
    QAction *addAction(ref const(QIcon) icon, ref const(QString) text,
    ...
    QAction *actionAt(ref const(QPoint) p) const;
...
private:
    ...
    Q_PRIVATE_SLOT(d_func(), void _q_updateIconSize(ref const(QSize) ))
