...
public:
    ...
    bool operator==(ref const(QSizePolicy) s) const { return data == s.data; }
    bool operator!=(ref const(QSizePolicy) s) const { return data != s.data; }
...
private:
    ...
    friend Q_WIDGETS_EXPORT QDataStream &operator<<(QDataStream &, ref const(QSizePolicy) );
...
Q_WIDGETS_EXPORT QDataStream &operator<<(QDataStream &, ref const(QSizePolicy) );
Q_WIDGETS_EXPORT QDataStream &operator>>(QDataStream &, QSizePolicy &);
#endif

#ifndef QT_NO_DEBUG_STREAM
Q_WIDGETS_EXPORT QDebug operator<<(QDebug dbg, ref const(QSizePolicy) );
#endif
