...
public import qt.QtWidgets.qdesktopwidget;
#endif
...
{
    mixin Q_OBJECT;
    mixin Q_PROPERTY!(QIcon, "windowIcon", "READ", "windowIcon", "WRITE", "setWindowIcon");
    mixin Q_PROPERTY!(int, "cursorFlashTime", "READ", "cursorFlashTime", "WRITE", "setCursorFlashTime");
    Q_PROPERTY(int doubleClickInterval  READ doubleClickInterval WRITE setDoubleClickInterval)
    mixin Q_PROPERTY!(int, "keyboardInputInterval", "READ", "keyboardInputInterval", "WRITE", "setKeyboardInputInterval");
#ifndef QT_NO_WHEELEVENT
    Q_PROPERTY(int wheelScrollLines  READ wheelScrollLines WRITE setWheelScrollLines)
#endif
    mixin Q_PROPERTY!(QSize, "globalStrut", "READ", "globalStrut", "WRITE", "setGlobalStrut");
...
#endif
#ifdef Q_OS_WINCE
    mixin Q_PROPERTY!(int, "autoMaximizeThreshold", "READ", "autoMaximizeThreshold", "WRITE", "setAutoMaximizeThreshold");
#endif
    mixin Q_PROPERTY!(bool, "autoSipEnabled", "READ", "autoSipEnabled", "WRITE", "setAutoSipEnabled");
...
public:
    ...
    QT_DEPRECATED static /+inline+/ void setGraphicsSystem(ref const(QString) ) {}
#endif
    ...
    static void setPalette(ref const(QPalette) , const(char)* className = 0);
    static QFont font();
    static QFont font(const QWidget*);
    static QFont font(const(char)* className);
    static void setFont(ref const(QFont) , const(char)* className = 0);
...
public Q_SLOTS:
#ifndef QT_NO_STYLE_STYLESHEET
    void setStyleSheet(ref const(QString) sheet);
#endif
#ifdef Q_OS_WINCE
