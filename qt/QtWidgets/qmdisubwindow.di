...
{
    mixin Q_OBJECT;
    mixin Q_PROPERTY!(int, "keyboardSingleStep", "READ", "keyboardSingleStep", "WRITE", "setKeyboardSingleStep");
    mixin Q_PROPERTY!(int, "keyboardPageStep", "READ", "keyboardPageStep", "WRITE", "setKeyboardPageStep");
public:
