...
public import qt.QtWidgets.qlineedit;
...
public:
    ...
    void setLabelText(ref const(QString) text);
    ...
    void setTextValue(ref const(QString) text);
    ...
    void setComboBoxItems(ref const(QStringList) items);
    ...
    void setOkButtonText(ref const(QString) text);
    QString okButtonText() const;

    void setCancelButtonText(ref const(QString) text);
    ...
    static QString getText(QWidget *parent, ref const(QString) title, ref const(QString) label,
                           ...
                           ref const(QString) text = QString(), bool *ok = 0, Qt.WindowFlags flags = 0,
    ...
    QT_DEPRECATED static /+inline+/ int getInteger(QWidget *parent, ref const(QString) title, ref const(QString) label, int value = 0,
                          int minValue = -2147483647, int maxValue = 2147483647,
                          int step = 1, bool *ok = 0, Qt.WindowFlags flags = 0)
    {
...
Q_SIGNALS:
    // ### emit signals!
    void textValueChanged(ref const(QString) text);
    void textValueSelected(ref const(QString) text);
...
private:
    ...
    Q_PRIVATE_SLOT(d_func(), void _q_currentRowChanged(ref const(QModelIndex), ref const(QModelIndex)))
};
