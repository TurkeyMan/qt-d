...
public:
    ...
    /+virtual+/ SubControl hitTestComplexControl(ComplexControl cc, const(QStyleOptionComplex)* opt,
                                             ref const(QPoint) pt, const(QWidget)* widget = 0) const = 0;
    ...
    /+virtual+/ QSize sizeFromContents(ContentsType ct, const(QStyleOption)* opt,
                                   ref const(QSize) contentsSize, const(QWidget)* w = 0) const = 0;
    ...
    /+virtual+/ QPixmap generatedIconPixmap(QIcon::Mode iconMode, ref const(QPixmap) pixmap,
                                        const(QStyleOption)* opt) const = 0;

    static QRect visualRect(Qt.LayoutDirection direction, ref const(QRect) boundingRect,
                            ref const(QRect) logicalRect);
    static QPoint visualPos(Qt.LayoutDirection direction, ref const(QRect) boundingRect,
