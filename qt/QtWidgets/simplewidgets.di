...
public:
    ...
    QStringList actionNames() const Q_DECL_OVERRIDE;
    void doAction(ref const(QString) actionName) Q_DECL_OVERRIDE;
    QStringList keyBindingsForAction(ref const(QString) ) const Q_DECL_OVERRIDE;
...
{
public:
    explicit QAccessibleLineEdit(QWidget *o, ref const(QString) name = QString());
...
public:
    ...
    void setCurrentValue(ref const(QVariant) ) Q_DECL_OVERRIDE {}
