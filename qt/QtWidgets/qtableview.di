...
{
    mixin Q_OBJECT;
    mixin Q_PROPERTY!(bool, "showGrid", "READ", "showGrid", "WRITE", "setShowGrid");
    mixin Q_PROPERTY!(Qt.PenStyle, "gridStyle", "READ", "gridStyle", "WRITE", "setGridStyle");
    ...
    mixin Q_PROPERTY!(bool, "cornerButtonEnabled", "READ", "isCornerButtonEnabled", "WRITE", "setCornerButtonEnabled");
...
protected:
    ...
    void currentChanged(ref const(QModelIndex) current,
