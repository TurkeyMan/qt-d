...
{
public:
    /+inline+/ explicit QItemEditorCreator(ref const(QByteArray) valuePropertyName);
...
template <class T>
Q_INLINE_TEMPLATE QItemEditorCreator<T>::QItemEditorCreator(ref const(QByteArray) avaluePropertyName)
