...
{
    mixin Q_OBJECT;
    mixin Q_PROPERTY!(qreal, "spacing", "READ", "spacing", "WRITE", "setSpacing", "RESET", "unsetSpacing");
    mixin Q_PROPERTY!(QSizePolicy::Policy, "sizePolicy", "READ", "sizePolicy", "WRITE", "setSizePolicy");
public:
