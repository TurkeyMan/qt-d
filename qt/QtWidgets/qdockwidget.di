...
class Q_WIDGETS_EXPORT QDockWidget : public QWidget
{
    ...
    mixin Q_PROPERTY!(bool, "floating", "READ", "isFloating", "WRITE", "setFloating");
    mixin Q_PROPERTY!(DockWidgetFeatures, "features", "READ", "features", "WRITE", "setFeatures", "NOTIFY", "featuresChanged");
    Q_PROPERTY(Qt.DockWidgetAreas allowedAreas READ allowedAreas
               WRITE setAllowedAreas NOTIFY allowedAreasChanged)
    mixin Q_PROPERTY!(QString, "windowTitle", "READ", "windowTitle", "WRITE", "setWindowTitle", "DESIGNABLE", "true");

public:
    explicit QDockWidget(ref const(QString) title, QWidget *parent = 0, Qt.WindowFlags flags = 0);
