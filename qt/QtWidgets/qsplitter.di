...
class Q_WIDGETS_EXPORT QSplitter : public QFrame
{
    ...
    mixin Q_PROPERTY!(bool, "opaqueResize", "READ", "opaqueResize", "WRITE", "setOpaqueResize");
    mixin Q_PROPERTY!(int, "handleWidth", "READ", "handleWidth", "WRITE", "setHandleWidth");
    mixin Q_PROPERTY!(bool, "childrenCollapsible", "READ", "childrenCollapsible", "WRITE", "setChildrenCollapsible");
...
public:
    ...
    void setSizes(ref const(QList<int>) list);
...
Q_WIDGETS_EXPORT QTextStream& operator<<(QTextStream&, ref const(QSplitter));
