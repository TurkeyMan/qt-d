...
public import qt.QtWidgets.qcombobox;
...
class Q_WIDGETS_EXPORT QFontComboBox : public QComboBox
{
    mixin Q_OBJECT;
    Q_FLAGS(FontFilters)
    mixin Q_PROPERTY!(QFontDatabase::WritingSystem, "writingSystem", "READ", "writingSystem", "WRITE", "setWritingSystem");
    mixin Q_PROPERTY!(FontFilters, "fontFilters", "READ", "fontFilters", "WRITE", "setFontFilters");
...
Q_SIGNALS:
    void currentFontChanged(ref const(QFont) f);
...
private:
    ...
    Q_PRIVATE_SLOT(d_func(), void _q_currentChanged(ref const(QString) ))
