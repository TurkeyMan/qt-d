...
public:
    ...
    void setSizePolicy(ref const(QSizePolicy) policy);
    void setSizePolicy(QSizePolicy::Policy hPolicy, QSizePolicy::Policy vPolicy, QSizePolicy::ControlType controlType = QSizePolicy::DefaultType);
    QSizePolicy sizePolicy() const;

    void setMinimumSize(ref const(QSizeF) size);
    ...
    void setPreferredSize(ref const(QSizeF) size);
    ...
    void setMaximumSize(ref const(QSizeF) size);
    ...
    QSizeF effectiveSizeHint(Qt.SizeHint which, ref const(QSizeF) constraint = QSizeF()) const;
...
protected:
    ...
    /+virtual+/ QSizeF sizeHint(Qt.SizeHint which, ref const(QSizeF) constraint = QSizeF()) const = 0;
    QScopedPointer<QGraphicsLayoutItemPrivate> d_ptr;

private:
    QSizeF *effectiveSizeHints(ref const(QSizeF) constraint) const;
