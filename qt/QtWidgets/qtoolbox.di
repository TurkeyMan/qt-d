...
public:
    ...
    int addItem(QWidget *widget, ref const(QString) text);
    int addItem(QWidget *widget, ref const(QIcon) icon, ref const(QString) text);
    int insertItem(int index, QWidget *widget, ref const(QString) text);
    int insertItem(int index, QWidget *widget, ref const(QIcon) icon, ref const(QString) text);
    ...
    void setItemToolTip(int index, ref const(QString) toolTip);
...
/+inline+/ int QToolBox::addItem(QWidget *item, ref const(QString) text)
{ return insertItem(-1, item, QIcon(), text); }
/+inline+/ int QToolBox::addItem(QWidget *item, ref const(QIcon) iconSet,
                              ref const(QString) text)
{ return insertItem(-1, item, iconSet, text); }
/+inline+/ int QToolBox::insertItem(int index, QWidget *item, ref const(QString) text)
