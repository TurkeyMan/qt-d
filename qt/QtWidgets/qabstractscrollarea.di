...
class Q_WIDGETS_EXPORT QAbstractScrollArea : public QFrame
{
    ...
    mixin Q_PROPERTY!(Qt.ScrollBarPolicy, "verticalScrollBarPolicy", "READ", "verticalScrollBarPolicy", "WRITE", "setVerticalScrollBarPolicy");
    mixin Q_PROPERTY!(Qt.ScrollBarPolicy, "horizontalScrollBarPolicy", "READ", "horizontalScrollBarPolicy", "WRITE", "setHorizontalScrollBarPolicy");
...
protected:
    ...
    void setViewportMargins(ref const(QMargins) margins);
