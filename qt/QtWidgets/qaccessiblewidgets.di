...
public import qt.QtWidgets.qaccessiblewidget;

#ifndef QT_NO_ACCESSIBILITY

public import qt.QtCore.QPointer;
...
{
public:
    QAccessibleTextWidget(QWidget *o, QAccessible::Role r = QAccessible::EditableText, ref const(QString) name = QString());
    ...
    int offsetAtPoint(ref const(QPoint) point) const Q_DECL_OVERRIDE;
    ...
    void insertText(int offset, ref const(QString) text) Q_DECL_OVERRIDE;
    void replaceText(int startOffset, int endOffset, ref const(QString) text) Q_DECL_OVERRIDE;
...
protected:
    ...
    /+virtual+/ void setTextCursor(ref const(QTextCursor) ) = 0;
...
public:
    ...
    void setText(QAccessible::Text t, ref const(QString) text) Q_DECL_OVERRIDE;
...
protected:
    ...
    void setTextCursor(ref const(QTextCursor) textCursor) Q_DECL_OVERRIDE;
...
public:
    ...
    void setText(QAccessible::Text textType, ref const(QString) text) Q_DECL_OVERRIDE;
    QAccessible::State state() const Q_DECL_OVERRIDE;
    int childCount() const Q_DECL_OVERRIDE;
    QAccessibleInterface *child(int index) const Q_DECL_OVERRIDE;
    int indexOfChild(const(QAccessibleInterface)* child) const Q_DECL_OVERRIDE;
