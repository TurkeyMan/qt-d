...
public:
    QScrollerProperties();
    QScrollerProperties(ref const(QScrollerProperties) sp);
    QScrollerProperties &operator=(ref const(QScrollerProperties) sp);
    /+virtual+/ ~QScrollerProperties();

    bool operator==(ref const(QScrollerProperties) sp) const;
    bool operator!=(ref const(QScrollerProperties) sp) const;

    static void setDefaultScrollerProperties(ref const(QScrollerProperties) sp);
    ...
    void setScrollMetric(ScrollMetric metric, ref const(QVariant) value);
