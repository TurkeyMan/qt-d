...
class Q_WIDGETS_EXPORT QMainWindow : public QWidget
{
    ...
    mixin Q_PROPERTY!(Qt.ToolButtonStyle, "toolButtonStyle", "READ", "toolButtonStyle", "WRITE", "setToolButtonStyle");
    ...
    mixin Q_PROPERTY!(bool, "dockNestingEnabled", "READ", "isDockNestingEnabled", "WRITE", "setDockNestingEnabled");
#endif // QT_NO_DOCKWIDGET
    mixin Q_PROPERTY!(DockOptions, "dockOptions", "READ", "dockOptions", "WRITE", "setDockOptions");
#ifndef QT_NO_TOOLBAR
    mixin Q_PROPERTY!(bool, "unifiedTitleAndToolBarOnMac", "READ", "unifiedTitleAndToolBarOnMac", "WRITE", "setUnifiedTitleAndToolBarOnMac");
#endif
...
public:
    ...
    void setIconSize(ref const(QSize) iconSize);
    ...
    bool isSeparator(ref const(QPoint) pos) const;
    ...
    QToolBar *addToolBar(ref const(QString) title);
    ...
    bool restoreState(ref const(QByteArray) state, int version = 0);
...
Q_SIGNALS:
    void iconSizeChanged(ref const(QSize) iconSize);
