...
public import qt.QtWidgets.qslider;
public import qt.QtWidgets.qstyle;
public import qt.QtWidgets.qtabbar;
public import qt.QtWidgets.qtabwidget;
public import qt.QtWidgets.qrubberband;
...
public:
    ...
    QStyleOption(ref const(QStyleOption) other);
    ~QStyleOption();

    void init(const(QWidget)* w);
    /+inline+/ void initFrom(const(QWidget)* w) { init(w); }
    QStyleOption &operator=(ref const(QStyleOption) other);
};
...
public:
    ...
    QStyleOptionFocusRect(ref const(QStyleOptionFocusRect) other) : QStyleOption(Version, Type) { *this = other; }
...
public:
    ...
    QStyleOptionFrame();
    QStyleOptionFrame(ref const(QStyleOptionFrame) other) : QStyleOption(Version, Type) { *this = other; }
...
public:
    ...
    /+inline+/ QStyleOptionTabWidgetFrame(ref const(QStyleOptionTabWidgetFrame) other)
...
public:
    ...
    QStyleOptionTabBarBase(ref const(QStyleOptionTabBarBase) other) : QStyleOption(Version, Type) { *this = other; }
...
public:
    ...
    QStyleOptionHeader();
    QStyleOptionHeader(ref const(QStyleOptionHeader) other) : QStyleOption(Version, Type) { *this = other; }
...
public:
    ...
    QStyleOptionButton();
    QStyleOptionButton(ref const(QStyleOptionButton) other) : QStyleOption(Version, Type) { *this = other; }
...
public:
    ...
    QStyleOptionTab();
    QStyleOptionTab(ref const(QStyleOptionTab) other) : QStyleOption(Version, Type) { *this = other; }
...
public:
    ...
    int midLineWidth;
    QStyleOptionToolBar();
    QStyleOptionToolBar(ref const(QStyleOptionToolBar) other) : QStyleOption(Version, Type) { *this = other; }
...
public:
    ...
    QStyleOptionProgressBar(ref const(QStyleOptionProgressBar) other) : QStyleOption(Version, Type) { *this = other; }
...
public:
    ...
    QStyleOptionMenuItem(ref const(QStyleOptionMenuItem) other) : QStyleOption(Version, Type) { *this = other; }
...
public:
    ...
    QStyleOptionDockWidget(ref const(QStyleOptionDockWidget) other) : QStyleOption(Version, Type) { *this = other; }
...
public:
    ...
    QStyleOptionViewItem(ref const(QStyleOptionViewItem) other) : QStyleOption(Version, Type) { *this = other; }
...
public:
    ...
    QStyleOptionToolBox();
    QStyleOptionToolBox(ref const(QStyleOptionToolBox) other) : QStyleOption(Version, Type) { *this = other; }
...
public:
    ...
    QStyleOptionRubberBand(ref const(QStyleOptionRubberBand) other) : QStyleOption(Version, Type) { *this = other; }
...
public:
    ...
    QStyleOptionComplex(ref const(QStyleOptionComplex) other) : QStyleOption(Version, Type) { *this = other; }
};
...
public:
    ...
    QStyleOptionSlider();
    QStyleOptionSlider(ref const(QStyleOptionSlider) other) : QStyleOptionComplex(Version, Type) { *this = other; }
...
public:
    ...
    QStyleOptionSpinBox();
    QStyleOptionSpinBox(ref const(QStyleOptionSpinBox) other) : QStyleOptionComplex(Version, Type) { *this = other; }
...
public:
    ...
    QStyleOptionToolButton(ref const(QStyleOptionToolButton) other) : QStyleOptionComplex(Version, Type) { *this = other; }
...
public:
    ...
    QStyleOptionComboBox(ref const(QStyleOptionComboBox) other) : QStyleOptionComplex(Version, Type) { *this = other; }
...
public:
    ...
    QStyleOptionTitleBar(ref const(QStyleOptionTitleBar) other) : QStyleOptionComplex(Version, Type) { *this = other; }
...
public:
    ...
    QStyleOptionGroupBox(ref const(QStyleOptionGroupBox) other) : QStyleOptionComplex(Version, Type) { *this = other; }
protected:
...
public:
    ...
    QStyleOptionSizeGrip(ref const(QStyleOptionSizeGrip) other) : QStyleOptionComplex(Version, Type) { *this = other; }
protected:
...
public:
    ...
    QStyleOptionGraphicsItem(ref const(QStyleOptionGraphicsItem) other) : QStyleOption(Version, Type) { *this = other; }
...
Q_WIDGETS_EXPORT QDebug operator<<(QDebug debug, ref const(QStyleOption::OptionType) optionType);
Q_WIDGETS_EXPORT QDebug operator<<(QDebug debug, ref const(QStyleOption) option);
#endif
