...
public import qt.QtWidgets.qmenu;
...
class Q_WIDGETS_EXPORT QMenuBar : public QWidget
{
    ...
    mixin Q_PROPERTY!(bool, "defaultUp", "READ", "isDefaultUp", "WRITE", "setDefaultUp");
    mixin Q_PROPERTY!(bool, "nativeMenuBar", "READ", "isNativeMenuBar", "WRITE", "setNativeMenuBar");
