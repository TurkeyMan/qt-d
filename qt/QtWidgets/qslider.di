...
class Q_WIDGETS_EXPORT QSlider : public QAbstractSlider
{
    ...
    mixin Q_PROPERTY!(TickPosition, "tickPosition", "READ", "tickPosition", "WRITE", "setTickPosition");
    mixin Q_PROPERTY!(int, "tickInterval", "READ", "tickInterval", "WRITE", "setTickInterval");
