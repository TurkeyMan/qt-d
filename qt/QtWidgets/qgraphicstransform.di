...
class Q_WIDGETS_EXPORT QGraphicsScale : public QGraphicsTransform
{
    ...
    mixin Q_PROPERTY!(QVector3D, "origin", "READ", "origin", "WRITE", "setOrigin", "NOTIFY", "originChanged");
    mixin Q_PROPERTY!(qreal, "xScale", "READ", "xScale", "WRITE", "setXScale", "NOTIFY", "xScaleChanged");
    mixin Q_PROPERTY!(qreal, "yScale", "READ", "yScale", "WRITE", "setYScale", "NOTIFY", "yScaleChanged");
    mixin Q_PROPERTY!(qreal, "zScale", "READ", "zScale", "WRITE", "setZScale", "NOTIFY", "zScaleChanged");
public:
    QGraphicsScale(QObject *parent = 0);
    ~QGraphicsScale();

    QVector3D origin() const;
    void setOrigin(ref const(QVector3D) point);
...
class Q_WIDGETS_EXPORT QGraphicsRotation : public QGraphicsTransform
{
    ...
    mixin Q_PROPERTY!(QVector3D, "origin", "READ", "origin", "WRITE", "setOrigin", "NOTIFY", "originChanged");
    mixin Q_PROPERTY!(qreal, "angle", "READ", "angle", "WRITE", "setAngle", "NOTIFY", "angleChanged");
    mixin Q_PROPERTY!(QVector3D, "axis", "READ", "axis", "WRITE", "setAxis", "NOTIFY", "axisChanged");
public:
    ...
    void setAxis(ref const(QVector3D) axis);
