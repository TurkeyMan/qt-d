...
public:
    ...
    /+virtual+/ void setName(ref const(QString) name) = 0;

    /+virtual+/ QString group() const = 0;
    /+virtual+/ void setGroup(ref const(QString) group) = 0;

    /+virtual+/ QString toolTip() const = 0;
    /+virtual+/ void setToolTip(ref const(QString) toolTip) = 0;

    /+virtual+/ QString whatsThis() const = 0;
    /+virtual+/ void setWhatsThis(ref const(QString) whatsThis) = 0;

    /+virtual+/ QString includeFile() const = 0;
    /+virtual+/ void setIncludeFile(ref const(QString) includeFile) = 0;

    /+virtual+/ QIcon icon() const = 0;
    /+virtual+/ void setIcon(ref const(QIcon) icon) = 0;
    ...
    /+virtual+/ void setPluginPath(ref const(QString) path) = 0;

    /+virtual+/ bool isPromoted() const = 0;
    /+virtual+/ void setPromoted(bool b) = 0;

    /+virtual+/ QString extends() const = 0;
    /+virtual+/ void setExtends(ref const(QString) s) = 0;

    /+virtual+/ void setDefaultPropertyValues(ref const(QList<QVariant>) list) = 0;
...
public:
    ...
    /+virtual+/ int indexOfClassName(ref const(QString) className, bool resolveName = true) const;
