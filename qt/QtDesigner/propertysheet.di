...
public:
    ...
    /+virtual+/ int indexOf(ref const(QString) name) const = 0;

    /+virtual+/ QString propertyName(int index) const = 0;
    /+virtual+/ QString propertyGroup(int index) const = 0;
    /+virtual+/ void setPropertyGroup(int index, ref const(QString) group) = 0;
    ...
    /+virtual+/ void setProperty(int index, ref const(QVariant) value) = 0;
