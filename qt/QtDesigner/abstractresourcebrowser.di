...
public:
    ...
    /+virtual+/ void setCurrentPath(ref const(QString) filePath) = 0;
    /+virtual+/ QString currentPath() const = 0;

Q_SIGNALS:
    void currentPathChanged(ref const(QString) filePath);
    void pathActivated(ref const(QString) filePath);
};
