...
public:
    ...
    void addPluginPath(ref const(QString) pluginPath);
    void setPluginPath(ref const(QStringList) pluginPaths);
...
protected:
    ...
    static QWidget *widgetByName(QWidget *topLevel, ref const(QString) name);
