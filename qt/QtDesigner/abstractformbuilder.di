...
public:
    ...
    void setWorkingDirectory(ref const(QDir) directory);
...
//
    ...
    /+virtual+/ void applyProperties(QObject *o, ref const(QList<DomProperty*>) properties);
    bool applyPropertyInternally(QObject *o, ref const(QString) propertyName, ref const(QVariant) value);

    /+virtual+/ void applyTabStops(QWidget *widget, DomTabStops *tabStops);

    /+virtual+/ QWidget *createWidget(ref const(QString) widgetName, QWidget *parentWidget, ref const(QString) name);
    /+virtual+/ QLayout *createLayout(ref const(QString) layoutName, QObject *parent, ref const(QString) name);
    /+virtual+/ QAction *createAction(QObject *parent, ref const(QString) name);
    /+virtual+/ QActionGroup *createActionGroup(QObject *parent, ref const(QString) name);
...
//
    ...
    /+virtual+/ bool checkProperty(QObject *obj, ref const(QString) prop) const;
    /+virtual+/ DomProperty *createProperty(QObject *object, ref const(QString) propertyName, ref const(QVariant) value);
    ...
    DomProperty *saveResource(ref const(QVariant) v) const;

    void setTextBuilder(QTextBuilder *builder);
    QTextBuilder *textBuilder() const;
    DomProperty *saveText(ref const(QString) attributeName, ref const(QVariant) v) const;
//
// utils
//
    ...
    static DomPropertyHash propertyMap(ref const(QList<DomProperty*>) properties);

    void setupColorGroup(QPalette &palette, QPalette::ColorGroup colorGroup, DomColorGroup *group);
    DomColorGroup *saveColorGroup(ref const(QPalette) palette);
    QBrush setupBrush(DomBrush *brush);
    DomBrush *saveBrush(ref const(QBrush) brush);
...
//
    ...
    IconPaths iconPaths(ref const(QIcon) ) const;
    IconPaths pixmapPaths(ref const(QPixmap) ) const;
    void setIconProperty(DomProperty &, ref const(IconPaths) ) const;
    void setPixmapProperty(DomProperty &, ref const(IconPaths) ) const;
    DomProperty* iconToDomProperty(ref const(QIcon) ) const;
...
//  utils
//
    static Qt.ToolBarArea toolbarAreaFromDOMAttributes(ref const(DomPropertyHash) attributeMap);

    QAbstractFormBuilder(ref const(QAbstractFormBuilder) other);
    void operator = (ref const(QAbstractFormBuilder) other);

    friend QDESIGNER_UILIB_EXPORT DomProperty *variantToDomProperty(QAbstractFormBuilder *abstractFormBuilder, const(QMetaObject)* meta, ref const(QString) propertyName, ref const(QVariant) value);
