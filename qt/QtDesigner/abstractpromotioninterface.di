...
public:
    ...
    /+virtual+/ bool addPromotedClass(ref const(QString) baseClass,
                                  ref const(QString) className,
                                  ref const(QString) includeFile,
                                  QString *errorMessage) = 0;

    /+virtual+/ bool removePromotedClass(ref const(QString) className, QString *errorMessage) = 0;

    /+virtual+/ bool changePromotedClassName(ref const(QString) oldClassName, ref const(QString) newClassName, QString *errorMessage) = 0;

    /+virtual+/ bool setPromotedClassIncludeFile(ref const(QString) className, ref const(QString) includeFile, QString *errorMessage) = 0;
