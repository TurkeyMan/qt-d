...
{
    mixin Q_OBJECT;
    mixin Q_PROPERTY!(QString, "headerSuffix", "READ", "headerSuffix", "WRITE", "setHeaderSuffix");
    mixin Q_PROPERTY!(bool, "headerLowercase", "READ", "isHeaderLowercase", "WRITE", "setHeaderLowercase");
...
public:
    ...
    /+virtual+/ void setHeaderSuffix(ref const(QString) headerSuffix) = 0;
    ...
    void emitObjectNameChanged(QDesignerFormWindowInterface *formWindow, QObject *object,
                               ref const(QString) newName, ref const(QString) oldName);
    void emitNavigateToSlot(ref const(QString) objectName, ref const(QString) signalSignature, ref const(QStringList) parameterNames);
    void emitNavigateToSlot(ref const(QString) slotSignature);
    void emitHelpRequested(ref const(QString) manual, ref const(QString) document);

Q_SIGNALS:
    void propertyChanged(QDesignerFormWindowInterface *formWindow, ref const(QString) name, ref const(QVariant) value);
    void objectNameChanged(QDesignerFormWindowInterface *formWindow, QObject *object, ref const(QString) newName, ref const(QString) oldName);
    void helpRequested(ref const(QString) manual, ref const(QString) document);

    void navigateToSlot(ref const(QString) objectName, ref const(QString) signalSignature, ref const(QStringList) parameterNames);
    void navigateToSlot(ref const(QString) slotSignature);

public Q_SLOTS:
    /+virtual+/ void setFeatures(Feature f) = 0;
    /+virtual+/ void updateProperty(ref const(QString) name, ref const(QVariant) value, bool enableSubPropertyHandling) = 0;
    /+virtual+/ void updateProperty(ref const(QString) name, ref const(QVariant) value) = 0;
    // Additional signals of designer property editor
    /+virtual+/ void resetProperty(ref const(QString) name) = 0;
    /+virtual+/ void addDynamicProperty(ref const(QString) name, ref const(QVariant) value) = 0;
    /+virtual+/ void removeDynamicProperty(ref const(QString) name) = 0;
...
public:
    ...
    void setHeaderSuffix(ref const(QString) headerSuffix);
    ...
    /+virtual+/ void updateProperty(ref const(QString) name, ref const(QVariant) value, bool enableSubPropertyHandling);
    /+virtual+/ void updateProperty(ref const(QString) name, ref const(QVariant) value);
    // Additional signals of designer property editor
    /+virtual+/ void resetProperty(ref const(QString) name);
    /+virtual+/ void addDynamicProperty(ref const(QString) name, ref const(QVariant) value);
    /+virtual+/ void removeDynamicProperty(ref const(QString) name);
