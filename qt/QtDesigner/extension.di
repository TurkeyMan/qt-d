...
public:
    ...
    /+virtual+/ QObject *extension(QObject *object, ref const(QString) iid) const = 0;
};
...
public:
    ...
    /+virtual+/ void registerExtensions(QAbstractExtensionFactory *factory, ref const(QString) iid) = 0;
    /+virtual+/ void unregisterExtensions(QAbstractExtensionFactory *factory, ref const(QString) iid) = 0;
