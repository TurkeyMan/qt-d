...
public import qt.QtDesigner.extension_global;
...
public:
    ...
    /+virtual+/ void registerExtensions(QAbstractExtensionFactory *factory, ref const(QString) iid = QString());
    /+virtual+/ void unregisterExtensions(QAbstractExtensionFactory *factory, ref const(QString) iid = QString());

    /+virtual+/ QObject *extension(QObject *object, ref const(QString) iid) const;
