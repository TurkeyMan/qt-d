...
public:
    ...
    typedef void (*DemarshallFunction)(ref const(QDBusArgument) , void *);
    ...
    static bool demarshall(ref const(QDBusArgument) , int id, void *data);
...
template<typename T>
void qDBusDemarshallHelper(ref const(QDBusArgument) arg, T *t)
{ arg >> *t; }
...
)
{
    ...
    void (*df)(ref const(QDBusArgument) , T *) = qDBusDemarshallHelper<T>;
