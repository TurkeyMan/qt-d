...
public:
    ...
    /+virtual+/ QString introspect(ref const(QString) path) const = 0;
    /+virtual+/ bool handleMessage(ref const(QDBusMessage) message, ref const(QDBusConnection) connection) = 0;
