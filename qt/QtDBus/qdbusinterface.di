...
public:
    QDBusInterface(ref const(QString) service, ref const(QString) path, ref const(QString) interface = QString(),
                   ref const(QDBusConnection) connection = QDBusConnection::sessionBus(),
                   QObject *parent = 0);
    ~QDBusInterface();
