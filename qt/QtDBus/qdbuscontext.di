...
public:
    ...
    ref const(QDBusMessage) message() const;

    // convenience methods
    bool isDelayedReply() const;
    // yes, they are const, so that you can use them even from const methods
    void setDelayedReply(bool enable) const;
    void sendErrorReply(ref const(QString) name, ref const(QString) msg = QString()) const;
    void sendErrorReply(QDBusError::ErrorType type, ref const(QString) msg = QString()) const;
