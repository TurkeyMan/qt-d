...
public:
    QBluetoothHostInfo();
    QBluetoothHostInfo(ref const(QBluetoothHostInfo) other);
    ~QBluetoothHostInfo();

    QBluetoothHostInfo &operator=(ref const(QBluetoothHostInfo) other);

    QBluetoothAddress address() const;
    void setAddress(ref const(QBluetoothAddress) address);
