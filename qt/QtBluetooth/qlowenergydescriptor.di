...
public:
    ...
    QLowEnergyDescriptor(ref const(QLowEnergyDescriptor) other);
    ~QLowEnergyDescriptor();

    QLowEnergyDescriptor &operator=(ref const(QLowEnergyDescriptor) other);
    bool operator==(ref const(QLowEnergyDescriptor) other) const;
    bool operator!=(ref const(QLowEnergyDescriptor) other) const;
