...
public:
    ...
    public:
        Sequence() { }
        Sequence(ref const(QList<QVariant>) list) : QList<QVariant>(list) { }
    };
    ...
    public:
        Alternative() { }
        Alternative(ref const(QList<QVariant>) list) : QList<QVariant>(list) { }
    };

    QBluetoothServiceInfo();
    QBluetoothServiceInfo(ref const(QBluetoothServiceInfo) other);
    ~QBluetoothServiceInfo();

    bool isValid() const;
    bool isComplete() const;

    void setDevice(ref const(QBluetoothDeviceInfo) info);
    QBluetoothDeviceInfo device() const;

    void setAttribute(quint16 attributeId, ref const(QVariant) value);
    void setAttribute(quint16 attributeId, ref const(QBluetoothUuid) value);
    void setAttribute(quint16 attributeId, ref const(QBluetoothServiceInfo::Sequence) value);
    void setAttribute(quint16 attributeId, ref const(QBluetoothServiceInfo::Alternative) value);
    ...
    /+inline+/ void setServiceName(ref const(QString) name);
    /+inline+/ QString serviceName() const;
    /+inline+/ void setServiceDescription(ref const(QString) description);
    /+inline+/ QString serviceDescription() const;
    /+inline+/ void setServiceProvider(ref const(QString) provider);
    ...
    /+inline+/ void setServiceUuid(ref const(QBluetoothUuid) uuid);
    /+inline+/ QBluetoothUuid serviceUuid() const;

    QList<QBluetoothUuid> serviceClassUuids() const;

    QBluetoothServiceInfo &operator=(ref const(QBluetoothServiceInfo) other);

    bool isRegistered() const;
    bool registerService(ref const(QBluetoothAddress) localAdapter = QBluetoothAddress());
    bool unregisterService();

protected:
    friend Q_BLUETOOTH_EXPORT QDebug operator<<(QDebug, ref const(QBluetoothServiceInfo) );
...
/+inline+/ void QBluetoothServiceInfo::setAttribute(quint16 attributeId, ref const(QBluetoothUuid) value)
{
    setAttribute(attributeId, QVariant::fromValue(value));
}

/+inline+/ void QBluetoothServiceInfo::setAttribute(quint16 attributeId, ref const(QBluetoothServiceInfo::Sequence) value)
{
    setAttribute(attributeId, QVariant::fromValue(value));
}

/+inline+/ void QBluetoothServiceInfo::setAttribute(quint16 attributeId, ref const(QBluetoothServiceInfo::Alternative) value)
{
    setAttribute(attributeId, QVariant::fromValue(value));
}

/+inline+/ void QBluetoothServiceInfo::setServiceName(ref const(QString) name)
{
...
/+inline+/ void QBluetoothServiceInfo::setServiceDescription(ref const(QString) description)
{
...
/+inline+/ void QBluetoothServiceInfo::setServiceProvider(ref const(QString) provider)
{
...
/+inline+/ void QBluetoothServiceInfo::setServiceUuid(ref const(QBluetoothUuid) uuid)
{
