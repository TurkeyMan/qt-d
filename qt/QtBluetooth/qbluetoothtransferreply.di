...
public import qt.QtBluetooth.QBluetoothTransferRequest;
public import qt.QtBluetooth.QBluetoothTransferManager;
...
protected:
    ...
    void setRequest(ref const(QBluetoothTransferRequest) request);
