...
public:
    ...
    QBluetoothDeviceInfo(ref const(QBluetoothAddress) address, ref const(QString) name,
                         quint32 classOfDevice);
    QBluetoothDeviceInfo(ref const(QBluetoothDeviceInfo) other);
    ~QBluetoothDeviceInfo();
    ...
    QBluetoothDeviceInfo &operator=(ref const(QBluetoothDeviceInfo) other);
    bool operator==(ref const(QBluetoothDeviceInfo) other) const;
    bool operator!=(ref const(QBluetoothDeviceInfo) other) const;
    ...
    void setServiceUuids(ref const(QList<QBluetoothUuid>) uuids, DataCompleteness completeness);
