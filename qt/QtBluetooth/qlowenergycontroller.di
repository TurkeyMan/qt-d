...
public import qt.QtBluetooth.QLowEnergyService;
...
public:
    ...
    explicit QLowEnergyController(ref const(QBluetoothAddress) remoteDevice,
                                     QObject *parent = 0);
    explicit QLowEnergyController(ref const(QBluetoothAddress) remoteDevice,
                                     ref const(QBluetoothAddress) localDevice,
                                     QObject *parent = 0);
    ...
    QLowEnergyService *createServiceObject(
            ref const(QBluetoothUuid) service, QObject *parent = 0);
...
Q_SIGNALS:
    ...
    void serviceDiscovered(ref const(QBluetoothUuid) newService);
