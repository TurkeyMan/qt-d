...
public import qt.QtBluetooth.QBluetoothSocket;
...
public:
    ...
    bool listen(ref const(QBluetoothAddress) address = QBluetoothAddress(), quint16 port = 0);
    QBluetoothServiceInfo listen(ref const(QBluetoothUuid) uuid, ref const(QString) serviceName = QString());
