...
public:
    ...
    void connectToService(ref const(QBluetoothServiceInfo) service, OpenMode openMode = ReadWrite);
    void connectToService(ref const(QBluetoothAddress) address, ref const(QBluetoothUuid) uuid, OpenMode openMode = ReadWrite);
    void connectToService(ref const(QBluetoothAddress) address, quint16 port, OpenMode openMode = ReadWrite);
...
protected:
    ...
    void doDeviceDiscovery(ref const(QBluetoothServiceInfo) service, OpenMode openMode);

private Q_SLOTS:
    void serviceDiscovered(ref const(QBluetoothServiceInfo) service);
