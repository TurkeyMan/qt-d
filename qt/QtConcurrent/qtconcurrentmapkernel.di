...
{
    SequenceHolder1(ref const(Sequence) _sequence, Functor functor)
...
/+inline+/ ThreadEngineStarter<T> startMapped(ref const(Sequence) sequence, Functor functor)
{
...
/+inline+/ ThreadEngineStarter<ResultType> startMappedReduced(ref const(Sequence)  sequence,
