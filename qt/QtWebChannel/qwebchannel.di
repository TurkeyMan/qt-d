...
class Q_WEBCHANNEL_EXPORT QWebChannel : public QObject
{
    ...
    mixin Q_PROPERTY!(bool, "blockUpdates", "READ", "blockUpdates", "WRITE", "setBlockUpdates", "NOTIFY", "blockUpdatesChanged");
public:
    ...
    Q_INVOKABLE void registerObject(ref const(QString) id, QObject *object);
